...
frameContext.runtime.sight_client = frameContext.runtime.entities[1];
frameContext.runtime.sight_entity = frameContext.runtime.entities[1];
frameContext.runtime.sight_entity_framenum = 7;
frameContext.runtime.sound_entity = frameContext.runtime.entities[1];
frameContext.runtime.sound_entity_framenum = 8;
frameContext.runtime.sound2_entity = frameContext.runtime.entities[1];
frameContext.runtime.sound2_entity_framenum = 9;
frameContext.runtime.pic_health = 77;
frameContext.runtime.total_secrets = 4;
frameContext.runtime.found_secrets = 2;
frameContext.runtime.total_goals = 3;
...
assert.equal(frameContext.level.sight_client, frameContext.runtime.entities[1], "G_RunFrame must mirror sight_client into level_locals_t");
assert.equal(frameContext.level.sight_entity, frameContext.runtime.entities[1], "G_RunFrame must mirror sight_entity into level_locals_t");
assert.equal(frameContext.level.sight_entity_framenum, 7, "G_RunFrame must mirror sight_entity_framenum into level_locals_t");
assert.equal(frameContext.level.sound_entity, frameContext.runtime.entities[1], "G_RunFrame must mirror sound_entity into level_locals_t");
assert.equal(frameContext.level.sound_entity_framenum, 8, "G_RunFrame must mirror sound_entity_framenum into level_locals_t");
assert.equal(frameContext.level.sound2_entity, frameContext.runtime.entities[1], "G_RunFrame must mirror sound2_entity into level_locals_t");
assert.equal(frameContext.level.sound2_entity_framenum, 9, "G_RunFrame must mirror sound2_entity_framenum into level_locals_t");
assert.equal(frameContext.level.pic_health, 77, "G_RunFrame must mirror pic_health into level_locals_t");
assert.equal(frameContext.level.total_secrets, 4, "G_RunFrame must mirror total_secrets into level_locals_t");
assert.equal(frameContext.level.found_secrets, 2, "G_RunFrame must mirror found_secrets into level_locals_t");
assert.equal(frameContext.level.total_goals, 3, "G_RunFrame must mirror total_goals into level_locals_t");
