...
assert.equal(meansOfDeathRuntime.meansOfDeath, MOD_ROCKET | MOD_FRIENDLY_FIRE, "meansOfDeath runtime global should preserve assigned mod bits");
...
assert.equal(gameClient.killer_yaw, 0, "gclient_s.killer_yaw default mismatch");
assert.equal(gameClient.weaponstate, weaponstate_t.WEAPON_READY, "gclient_s.weaponstate default mismatch");
assert.deepEqual(gameClient.kick_angles, [0, 0, 0], "gclient_s.kick_angles default mismatch");
assert.deepEqual(gameClient.kick_origin, [0, 0, 0], "gclient_s.kick_origin default mismatch");
assert.equal(gameClient.v_dmg_roll, 0, "gclient_s.v_dmg_roll default mismatch");
assert.equal(gameClient.v_dmg_pitch, 0, "gclient_s.v_dmg_pitch default mismatch");
assert.equal(gameClient.v_dmg_time, 0, "gclient_s.v_dmg_time default mismatch");
assert.equal(gameClient.fall_time, 0, "gclient_s.fall_time default mismatch");
assert.equal(gameClient.fall_value, 0, "gclient_s.fall_value default mismatch");
assert.equal(gameClient.damage_alpha, 0, "gclient_s.damage_alpha default mismatch");
assert.equal(gameClient.bonus_alpha, 0, "gclient_s.bonus_alpha default mismatch");
assert.deepEqual(gameClient.damage_blend, [0, 0, 0], "gclient_s.damage_blend default mismatch");
assert.deepEqual(gameClient.v_angle, [0, 0, 0], "gclient_s.v_angle default mismatch");
assert.equal(gameClient.bobtime, 0, "gclient_s.bobtime default mismatch");
assert.deepEqual(gameClient.oldviewangles, [0, 0, 0], "gclient_s.oldviewangles default mismatch");
assert.deepEqual(gameClient.oldvelocity, [0, 0, 0], "gclient_s.oldvelocity default mismatch");
assert.equal(gameClient.next_drown_time, 0, "gclient_s.next_drown_time default mismatch");
assert.equal(gameClient.old_waterlevel, 0, "gclient_s.old_waterlevel default mismatch");
assert.equal(gameClient.breather_sound, 0, "gclient_s.breather_sound default mismatch");
assert.equal(gameClient.machinegun_shots, 0, "gclient_s.machinegun_shots default mismatch");
assert.equal(gameClient.anim_end, 0, "gclient_s.anim_end default mismatch");
assert.equal(gameClient.anim_priority, ANIM_BASIC, "gclient_s.anim_priority default mismatch");
assert.equal(gameClient.anim_duck, false, "gclient_s.anim_duck default mismatch");
assert.equal(gameClient.anim_run, false, "gclient_s.anim_run default mismatch");
assert.equal(gameClient.quad_framenum, 0, "gclient_s.quad_framenum default mismatch");
assert.equal(gameClient.invincible_framenum, 0, "gclient_s.invincible_framenum default mismatch");
assert.equal(gameClient.breather_framenum, 0, "gclient_s.breather_framenum default mismatch");
assert.equal(gameClient.enviro_framenum, 0, "gclient_s.enviro_framenum default mismatch");
assert.equal(gameClient.grenade_blew_up, false, "gclient_s.grenade_blew_up default mismatch");
assert.equal(gameClient.grenade_time, 0, "gclient_s.grenade_time default mismatch");
assert.equal(gameClient.silencer_shots, 0, "gclient_s.silencer_shots default mismatch");
assert.equal(gameClient.weapon_sound, 0, "gclient_s.weapon_sound default mismatch");
assert.equal(gameClient.pickup_msg_time, 0, "gclient_s.pickup_msg_time default mismatch");
assert.equal(gameClient.flood_locktill, 0, "gclient_s.flood_locktill default mismatch");
assert.deepEqual(gameClient.flood_when, new Array<number>(10).fill(0), "gclient_s.flood_when default mismatch");
assert.equal(gameClient.flood_whenhead, 0, "gclient_s.flood_whenhead default mismatch");
assert.equal(gameClient.respawn_time, 0, "gclient_s.respawn_time default mismatch");
assert.equal(gameClient.chase_target, null, "gclient_s.chase_target default mismatch");
assert.equal(gameClient.update_chase, false, "gclient_s.update_chase default mismatch");
...
gameClient.killer_yaw = 12;
gameClient.weaponstate = weaponstate_t.WEAPON_FIRING;
gameClient.kick_angles = [13, 14, 15];
gameClient.kick_origin = [16, 17, 18];
gameClient.v_dmg_roll = 19;
gameClient.v_dmg_pitch = 20;
gameClient.v_dmg_time = 21;
gameClient.fall_time = 22;
gameClient.fall_value = 23;
gameClient.damage_alpha = 0.24;
gameClient.bonus_alpha = 0.25;
gameClient.damage_blend = [26, 27, 28];
gameClient.v_angle = [29, 30, 31];
gameClient.bobtime = 32;
gameClient.oldviewangles = [33, 34, 35];
gameClient.oldvelocity = [36, 37, 38];
gameClient.next_drown_time = 39;
gameClient.old_waterlevel = 2;
gameClient.breather_sound = 1;
gameClient.machinegun_shots = 3;
gameClient.anim_end = 40;
gameClient.anim_priority = ANIM_ATTACK;
gameClient.anim_duck = true;
gameClient.anim_run = true;
gameClient.quad_framenum = 41;
gameClient.invincible_framenum = 42;
gameClient.breather_framenum = 43;
gameClient.enviro_framenum = 44;
gameClient.grenade_blew_up = true;
gameClient.grenade_time = 45;
gameClient.silencer_shots = 46;
gameClient.weapon_sound = 47;
gameClient.pickup_msg_time = 48;
gameClient.flood_locktill = 49;
gameClient.flood_when[3] = 50;
gameClient.flood_whenhead = 4;
gameClient.respawn_time = 51;
gameClient.chase_target = entity;
gameClient.update_chase = true;
...
assert.equal(gameClient.killer_yaw, 12, "gclient_s.killer_yaw mutable field mismatch");
assert.equal(gameClient.weaponstate, weaponstate_t.WEAPON_FIRING, "gclient_s.weaponstate mutable field mismatch");
assert.deepEqual(gameClient.kick_angles, [13, 14, 15], "gclient_s.kick_angles mutable field mismatch");
assert.deepEqual(gameClient.kick_origin, [16, 17, 18], "gclient_s.kick_origin mutable field mismatch");
assert.equal(gameClient.v_dmg_roll, 19, "gclient_s.v_dmg_roll mutable field mismatch");
assert.equal(gameClient.v_dmg_pitch, 20, "gclient_s.v_dmg_pitch mutable field mismatch");
assert.equal(gameClient.v_dmg_time, 21, "gclient_s.v_dmg_time mutable field mismatch");
assert.equal(gameClient.fall_time, 22, "gclient_s.fall_time mutable field mismatch");
assert.equal(gameClient.fall_value, 23, "gclient_s.fall_value mutable field mismatch");
assert.equal(gameClient.damage_alpha, 0.24, "gclient_s.damage_alpha mutable field mismatch");
assert.equal(gameClient.bonus_alpha, 0.25, "gclient_s.bonus_alpha mutable field mismatch");
assert.deepEqual(gameClient.damage_blend, [26, 27, 28], "gclient_s.damage_blend mutable field mismatch");
assert.deepEqual(gameClient.v_angle, [29, 30, 31], "gclient_s.v_angle mutable field mismatch");
assert.equal(gameClient.bobtime, 32, "gclient_s.bobtime mutable field mismatch");
assert.deepEqual(gameClient.oldviewangles, [33, 34, 35], "gclient_s.oldviewangles mutable field mismatch");
assert.deepEqual(gameClient.oldvelocity, [36, 37, 38], "gclient_s.oldvelocity mutable field mismatch");
assert.equal(gameClient.next_drown_time, 39, "gclient_s.next_drown_time mutable field mismatch");
assert.equal(gameClient.old_waterlevel, 2, "gclient_s.old_waterlevel mutable field mismatch");
assert.equal(gameClient.breather_sound, 1, "gclient_s.breather_sound mutable field mismatch");
assert.equal(gameClient.machinegun_shots, 3, "gclient_s.machinegun_shots mutable field mismatch");
assert.equal(gameClient.anim_end, 40, "gclient_s.anim_end mutable field mismatch");
assert.equal(gameClient.anim_priority, ANIM_ATTACK, "gclient_s.anim_priority mutable field mismatch");
assert.equal(gameClient.anim_duck, true, "gclient_s.anim_duck mutable field mismatch");
assert.equal(gameClient.anim_run, true, "gclient_s.anim_run mutable field mismatch");
assert.equal(gameClient.quad_framenum, 41, "gclient_s.quad_framenum mutable field mismatch");
assert.equal(gameClient.invincible_framenum, 42, "gclient_s.invincible_framenum mutable field mismatch");
assert.equal(gameClient.breather_framenum, 43, "gclient_s.breather_framenum mutable field mismatch");
assert.equal(gameClient.enviro_framenum, 44, "gclient_s.enviro_framenum mutable field mismatch");
assert.equal(gameClient.grenade_blew_up, true, "gclient_s.grenade_blew_up mutable field mismatch");
assert.equal(gameClient.grenade_time, 45, "gclient_s.grenade_time mutable field mismatch");
assert.equal(gameClient.silencer_shots, 46, "gclient_s.silencer_shots mutable field mismatch");
assert.equal(gameClient.weapon_sound, 47, "gclient_s.weapon_sound mutable field mismatch");
assert.equal(gameClient.pickup_msg_time, 48, "gclient_s.pickup_msg_time mutable field mismatch");
assert.equal(gameClient.flood_locktill, 49, "gclient_s.flood_locktill mutable field mismatch");
assert.equal(gameClient.flood_when[3], 50, "gclient_s.flood_when mutable field mismatch");
assert.equal(gameClient.flood_whenhead, 4, "gclient_s.flood_whenhead mutable field mismatch");
assert.equal(gameClient.respawn_time, 51, "gclient_s.respawn_time mutable field mismatch");
assert.equal(gameClient.chase_target, entity, "gclient_s.chase_target mutable field mismatch");
assert.equal(gameClient.update_chase, true, "gclient_s.update_chase mutable field mismatch");
...
assert.deepEqual(secondClient.kick_angles, [0, 0, 0], "gclient_s.kick_angles instances must not alias");
assert.deepEqual(secondClient.kick_origin, [0, 0, 0], "gclient_s.kick_origin instances must not alias");
assert.deepEqual(secondClient.damage_blend, [0, 0, 0], "gclient_s.damage_blend instances must not alias");
assert.deepEqual(secondClient.v_angle, [0, 0, 0], "gclient_s.v_angle instances must not alias");
assert.deepEqual(secondClient.oldviewangles, [0, 0, 0], "gclient_s.oldviewangles instances must not alias");
