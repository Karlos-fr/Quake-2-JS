...
import {
  ...
  MOD_SHOTGUN,
  MOD_SSHOTGUN,
  MOVETYPE_BOUNCE as RUNTIME_MOVETYPE_BOUNCE,
  MOVETYPE_FLY as RUNTIME_MOVETYPE_FLY,
  MOVETYPE_FLYMISSILE as RUNTIME_MOVETYPE_FLYMISSILE,
  MOVETYPE_NOCLIP as RUNTIME_MOVETYPE_NOCLIP,
  MOVETYPE_NONE as RUNTIME_MOVETYPE_NONE,
  MOVETYPE_PUSH as RUNTIME_MOVETYPE_PUSH,
  MOVETYPE_STEP as RUNTIME_MOVETYPE_STEP,
  MOVETYPE_STOP as RUNTIME_MOVETYPE_STOP,
  MOVETYPE_TOSS as RUNTIME_MOVETYPE_TOSS,
  MOVETYPE_WALK as RUNTIME_MOVETYPE_WALK,
  POWER_ARMOR_NONE,
  POWER_ARMOR_SCREEN,
  POWER_ARMOR_SHIELD,
  RIGHT_HANDED,
...
export const FL_PARTIALGROUND = 0x00000100;
export const FL_WATERJUMP = 0x00000200;
...
export enum movetype_t {
  MOVETYPE_NONE = RUNTIME_MOVETYPE_NONE,
  MOVETYPE_NOCLIP = RUNTIME_MOVETYPE_NOCLIP,
  MOVETYPE_PUSH = RUNTIME_MOVETYPE_PUSH,
  MOVETYPE_STOP = RUNTIME_MOVETYPE_STOP,
  MOVETYPE_WALK = RUNTIME_MOVETYPE_WALK,
  MOVETYPE_STEP = RUNTIME_MOVETYPE_STEP,
  MOVETYPE_FLY = RUNTIME_MOVETYPE_FLY,
  MOVETYPE_TOSS = RUNTIME_MOVETYPE_TOSS,
  MOVETYPE_FLYMISSILE = RUNTIME_MOVETYPE_FLYMISSILE,
  MOVETYPE_BOUNCE = RUNTIME_MOVETYPE_BOUNCE
}

export const MOVETYPE_NONE = RUNTIME_MOVETYPE_NONE;
export const MOVETYPE_NOCLIP = RUNTIME_MOVETYPE_NOCLIP;
export const MOVETYPE_PUSH = RUNTIME_MOVETYPE_PUSH;
export const MOVETYPE_STOP = RUNTIME_MOVETYPE_STOP;
export const MOVETYPE_WALK = RUNTIME_MOVETYPE_WALK;
export const MOVETYPE_STEP = RUNTIME_MOVETYPE_STEP;
export const MOVETYPE_FLY = RUNTIME_MOVETYPE_FLY;
export const MOVETYPE_TOSS = RUNTIME_MOVETYPE_TOSS;
export const MOVETYPE_FLYMISSILE = RUNTIME_MOVETYPE_FLYMISSILE;
export const MOVETYPE_BOUNCE = RUNTIME_MOVETYPE_BOUNCE;
