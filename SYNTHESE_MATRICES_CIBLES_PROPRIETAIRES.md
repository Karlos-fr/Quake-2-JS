...
- Matrices avec une seule valeur non vide dans `Fichier cible proprietaire`: 98
- Matrices sans ligne: 4
- Matrices avec lignes mais sans cible proprietaire renseignee: 0
- Matrices avec plusieurs valeurs distinctes: 40
...
| [client_cl_ents.c.md](audit-portage/validation-incrementale/validation/matrices/client_cl_ents.c.md) | `Quake-2-master/client/cl_ents.c` | 52 | Non - plusieurs valeurs | `packages/client/src/cl_ents.ts`<br>`packages/client/src/cl_parse.ts`<br>`packages/client/src/refresh.ts`<br>`packages/client/src/view.ts` |
| [client_cl_fx.c.md](audit-portage/validation-incrementale/validation/matrices/client_cl_fx.c.md) | `Quake-2-master/client/cl_fx.c` | 145 | Non - plusieurs valeurs | `packages/client/src/cl_fx.ts`<br>`packages/client/src/cl_newfx.ts`<br>`packages/client/src/cl_parse.ts` |
...
| [client_cl_inv.c.md](audit-portage/validation-incrementale/validation/matrices/client_cl_inv.c.md) | `Quake-2-master/client/cl_inv.c` | 12 | Non - plusieurs valeurs | `packages/client/src/cl_inv.ts`<br>`packages/client/src/cl_parse.ts` |
...
| [client_cl_parse.c.md](audit-portage/validation-incrementale/validation/matrices/client_cl_parse.c.md) | `Quake-2-master/client/cl_parse.c` | 55 | Non - plusieurs valeurs | `packages/client/src/cl_parse.ts`<br>`packages/client/src/cl_scrn.ts`<br>`packages/client/src/download.ts`<br>`packages/client/src/sound.ts` |
| [client_cl_pred.c.md](audit-portage/validation-incrementale/validation/matrices/client_cl_pred.c.md) | `Quake-2-master/client/cl_pred.c` | 29 | Oui | `packages/client/src/view.ts` |
...
| [client_cl_view.c.md](audit-portage/validation-incrementale/validation/matrices/client_cl_view.c.md) | `Quake-2-master/client/cl_view.c` | 37 | Non - plusieurs valeurs | `packages/client/src/menu-player-config.ts`<br>`packages/client/src/view.ts` |
| [client_client.h.md](audit-portage/validation-incrementale/validation/matrices/client_client.h.md) | `Quake-2-master/client/client.h` | 276 | Non - plusieurs valeurs | `packages/client/src/client.ts`<br>`packages/client/src/keys.ts` |
...
| [client_sound.h.md](audit-portage/validation-incrementale/validation/matrices/client_sound.h.md) | `Quake-2-master/client/sound.h` | 13 | Oui | `packages/client/src/sound-public.ts` |
...
| [game_g_func.c.md](audit-portage/validation-incrementale/validation/matrices/game_g_func.c.md) | `Quake-2-master/game/g_func.c` | 150 | Non - plusieurs valeurs | `packages/game/src/g_func.ts`<br>`packages/game/src/g_misc.ts` |
...
| [qcommon_crc.c.md](audit-portage/validation-incrementale/validation/matrices/qcommon_crc.c.md) | `Quake-2-master/qcommon/crc.c` | 8 | Oui | `packages/qcommon/src/qcommon.ts` |
| [qcommon_crc.h.md](audit-portage/validation-incrementale/validation/matrices/qcommon_crc.h.md) | `Quake-2-master/qcommon/crc.h` | 4 | Oui | `packages/qcommon/src/qcommon.ts` |
...
| [ref_gl_gl_model.c.md](audit-portage/validation-incrementale/validation/matrices/ref_gl_gl_model.c.md) | `Quake-2-master/ref_gl/gl_model.c` | 42 | Oui | `packages/renderer-three/src/gl-model-loader.ts` |
| [ref_gl_gl_model.h.md](audit-portage/validation-incrementale/validation/matrices/ref_gl_gl_model.h.md) | `Quake-2-master/ref_gl/gl_model.h` | 31 | Oui | `packages/renderer-three/src/gl-model.ts` |
