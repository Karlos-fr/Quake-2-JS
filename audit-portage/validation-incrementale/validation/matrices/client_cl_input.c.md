...
- Cibles TS connues: `packages/client/src/cl_input.ts`, `packages/client/src/client.ts`, `packages/client/src/input.ts`
- Tests connus: aucun
- Verdict Phase 03: A redecouper
- Findings Phase 03: `missing-linked-test-for-some-symbols`, `missing-ts-symbols:22`, `multiple-declared-ts-targets`, `phase02-structural-status:split-undocumented`, `unreachable-functions:35`
...
| `Quake-2-master/client/cl_input.c` | global | `in_impulse` | `packages/client/src/cl_input.ts` | `IN_Impulse` | Valide | A redecouper |  |
