...
- Cibles TS connues: `packages/client/src/cl_newfx.ts`, `packages/client/src/cl_fx.ts`, `packages/client/src/cl_parse.ts`, `packages/client/src/cl_tent.ts`, `packages/client/src/refresh.ts`
- Tests connus: aucun
- Verdict Phase 03: A redecouper
- Findings Phase 03: `missing-linked-test-for-some-symbols`, `missing-ts-symbols:10`, `multiple-declared-ts-targets`, `phase02-structural-status:split-undocumented`, `unreachable-functions:7`
...
| `Quake-2-master/client/cl_newfx.c` | function | `MakeNormalVectors` | `packages/client/src/cl_fx.ts` | `MakeNormalVectors` | A verifier | A redecouper |  |
