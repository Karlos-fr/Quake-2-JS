...
| `Quake-2-master/game/m_boss2.c` | global | `sound_death` | `packages/game/src/m_boss2.ts` | `SOUND_DEATH` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_boss2.c` | global | `sound_search1` | `packages/game/src/m_boss2.ts` | `SOUND_SEARCH1` | A verifier | A redecouper |  |
