...
- Cibles TS connues: `packages/server/src/sv_ccmds.ts`, `packages/server/src/index.ts`, `packages/server/src/runtime.ts`, `packages/server/src/server.ts`
- Tests connus: aucun
- Verdict Phase 03: A redecouper
- Findings Phase 03: `missing-linked-test-for-some-symbols`, `missing-ts-symbols:6`, `multiple-declared-ts-targets`, `no-function-reached-from-runtime-roots`, `phase02-structural-status:split-undocumented`, `unreachable-functions:25`
