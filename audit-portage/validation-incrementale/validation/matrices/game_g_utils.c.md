...
- Cibles TS connues: `packages/game/src/g_utils.ts`, `packages/game/src/touch.ts`, `packages/game/src/g_weapon.ts`, `packages/game/src/runtime.ts`
- Tests connus: aucun
- Verdict Phase 03: A redecouper
- Findings Phase 03: `basename-collision`, `header:stub marker detected`, `header:temporary marker detected`, `missing-linked-test-for-some-symbols`, `missing-ts-symbols:8`, `multiple-declared-ts-targets`, `phase02-structural-status:split-undocumented`, `unreachable-functions:5`
