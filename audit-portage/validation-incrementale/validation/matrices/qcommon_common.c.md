...
- Cibles TS connues: `packages/qcommon/src/common.ts`, `packages/memory/src/sizebuf.ts`, `packages/qcommon/src/messages.ts`, `packages/qcommon/src/qcommon.ts`, `packages/qcommon/src/runtime.ts`
- Tests connus: aucun
- Verdict Phase 03: A redecouper
- Findings Phase 03: `header:stub marker detected`, `header:temporary marker detected`, `missing-linked-test-for-some-symbols`, `missing-ts-symbols:60`, `multiple-declared-ts-targets`, `phase02-structural-status:split-undocumented`, `unreachable-functions:22`
...
| `Quake-2-master/qcommon/common.c` | global | `timescale` | `packages/qcommon/src/qcommon.ts` | `timescale` | Valide | A redecouper |  |
| `Quake-2-master/qcommon/common.c` | global | `fixedtime` | `packages/qcommon/src/qcommon.ts` | `fixedtime` | Valide | A redecouper |  |
