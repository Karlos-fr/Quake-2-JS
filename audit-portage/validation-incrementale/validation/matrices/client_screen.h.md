...
- Cibles TS connues: `packages/client/src/cl_scrn.ts`, `packages/client/src/screen.ts`, `packages/client/src/cl_cin.ts`, `packages/client/src/client.ts`
- Tests connus: aucun
- Verdict Phase 03: A redecouper
- Findings Phase 03: `declared-target-not-strict-basename`, `header:Source header 'Quake II original / client/cl_scrn.c' does not clearly reference source`, `header:stub marker detected`, `missing-linked-test-for-some-symbols`, `missing-ts-symbols:7`, `multiple-declared-ts-targets`, `name:primary-basename 'cl_scrn' differs from source basename 'screen'`, `phase02-structural-status:split-undocumented`, `strict-basename-target-missing`, `unreachable-functions:3`
