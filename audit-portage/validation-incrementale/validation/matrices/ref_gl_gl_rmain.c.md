...
- Cibles TS connues: `packages/renderer-three/src/gl_rmain.ts`, `packages/renderer-three/src/gl_light.ts`, `packages/renderer-three/src/gl_rsurf.ts`, `packages/renderer-three/src/particle-sync.ts`, `packages/renderer-three/src/ref-gl-host.ts`, `packages/renderer-three/src/refresh-entity-sync.ts`
