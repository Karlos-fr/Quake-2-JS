...
- Cibles TS connues: `packages/renderer-three/src/gl_light.ts`, `packages/renderer-three/src/gl_rmain.ts`, `packages/renderer-three/src/gl_rsurf.ts`, `packages/renderer-three/src/index.ts`
