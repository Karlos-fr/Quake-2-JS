...
- Cibles TS connues: `packages/game/src/m_boss3.ts`, `packages/game/src/g_save.ts`, `packages/game/src/g_spawn.ts`, `packages/game/src/index.ts`
- Tests connus: aucun
- Verdict Phase 03: A redecouper
- Findings Phase 03: `missing-linked-test-for-some-symbols`, `multiple-declared-ts-targets`, `no-function-reached-from-runtime-roots`, `phase02-structural-status:split-undocumented`, `unreachable-functions:3`
