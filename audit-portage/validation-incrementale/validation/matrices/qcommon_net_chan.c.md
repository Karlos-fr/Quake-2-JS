...
| `Quake-2-master/qcommon/net_chan.c` | global | `qport` | `packages/qcommon/src/net_chan.ts` |  | Valide | A redecouper |  |
...
| `Quake-2-master/qcommon/net_chan.c` | global | `qport` | `packages/qcommon/src/net_chan.ts` |  | Non applicable | A redecouper | Variable locale de `Netchan_Process`, lue uniquement pour avancer le curseur serveur comme dans le C; pas une entite proprietaire separee. |
| `Quake-2-master/qcommon/net_chan.c` | function | `Com_Printf` | `packages/qcommon/src/net_chan.ts` |  | A verifier | A redecouper |  |
