...
- Cibles TS connues: `packages/client/src/snd_dma.ts`, `packages/client/src/index.ts`, `packages/client/src/snd_loc.ts`, `packages/client/src/snd_mix.ts`
- Tests connus: aucun
- Verdict Phase 03: A redecouper
- Findings Phase 03: `header:stub marker detected`, `missing-linked-test-for-some-symbols`, `missing-ts-symbols:32`, `multiple-declared-ts-targets`, `phase02-structural-status:split-undocumented`, `unreachable-functions:5`
...
| `Quake-2-master/client/snd_dma.c` | global | `soundtime` | `packages/client/src/snd_dma.ts` | `soundtime` | Valide | A redecouper |  |
