...
| --- | --- | --- | --- | --- | --- | --- | --- |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_stand1` | `packages/game/src/m_berserk.ts` | `FRAME_stand1` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_stand2` | `packages/game/src/m_berserk.ts` | `FRAME_stand2` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_stand3` | `packages/game/src/m_berserk.ts` | `FRAME_stand3` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_stand4` | `packages/game/src/m_berserk.ts` | `FRAME_stand4` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_stand5` | `packages/game/src/m_berserk.ts` | `FRAME_stand5` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb1` | `packages/game/src/m_berserk.ts` | `FRAME_standb1` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb2` | `packages/game/src/m_berserk.ts` | `FRAME_standb2` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb3` | `packages/game/src/m_berserk.ts` | `FRAME_standb3` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb4` | `packages/game/src/m_berserk.ts` | `FRAME_standb4` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb5` | `packages/game/src/m_berserk.ts` | `FRAME_standb5` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb6` | `packages/game/src/m_berserk.ts` | `FRAME_standb6` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb7` | `packages/game/src/m_berserk.ts` | `FRAME_standb7` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb8` | `packages/game/src/m_berserk.ts` | `FRAME_standb8` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb9` | `packages/game/src/m_berserk.ts` | `FRAME_standb9` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb10` | `packages/game/src/m_berserk.ts` | `FRAME_standb10` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb11` | `packages/game/src/m_berserk.ts` | `FRAME_standb11` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb12` | `packages/game/src/m_berserk.ts` | `FRAME_standb12` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb13` | `packages/game/src/m_berserk.ts` | `FRAME_standb13` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb14` | `packages/game/src/m_berserk.ts` | `FRAME_standb14` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb15` | `packages/game/src/m_berserk.ts` | `FRAME_standb15` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb16` | `packages/game/src/m_berserk.ts` | `FRAME_standb16` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb17` | `packages/game/src/m_berserk.ts` | `FRAME_standb17` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb18` | `packages/game/src/m_berserk.ts` | `FRAME_standb18` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb19` | `packages/game/src/m_berserk.ts` | `FRAME_standb19` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_standb20` | `packages/game/src/m_berserk.ts` | `FRAME_standb20` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc1` | `packages/game/src/m_berserk.ts` | `FRAME_walkc1` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc2` | `packages/game/src/m_berserk.ts` | `FRAME_walkc2` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc3` | `packages/game/src/m_berserk.ts` | `FRAME_walkc3` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc4` | `packages/game/src/m_berserk.ts` | `FRAME_walkc4` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc5` | `packages/game/src/m_berserk.ts` | `FRAME_walkc5` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc6` | `packages/game/src/m_berserk.ts` | `FRAME_walkc6` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc7` | `packages/game/src/m_berserk.ts` | `FRAME_walkc7` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc8` | `packages/game/src/m_berserk.ts` | `FRAME_walkc8` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc9` | `packages/game/src/m_berserk.ts` | `FRAME_walkc9` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc10` | `packages/game/src/m_berserk.ts` | `FRAME_walkc10` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_walkc11` | `packages/game/src/m_berserk.ts` | `FRAME_walkc11` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_run1` | `packages/game/src/m_berserk.ts` | `FRAME_run1` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_run2` | `packages/game/src/m_berserk.ts` | `FRAME_run2` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_run3` | `packages/game/src/m_berserk.ts` | `FRAME_run3` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_run4` | `packages/game/src/m_berserk.ts` | `FRAME_run4` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_run5` | `packages/game/src/m_berserk.ts` | `FRAME_run5` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_run6` | `packages/game/src/m_berserk.ts` | `FRAME_run6` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a1` | `packages/game/src/m_berserk.ts` | `FRAME_att_a1` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a2` | `packages/game/src/m_berserk.ts` | `FRAME_att_a2` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a3` | `packages/game/src/m_berserk.ts` | `FRAME_att_a3` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a4` | `packages/game/src/m_berserk.ts` | `FRAME_att_a4` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a5` | `packages/game/src/m_berserk.ts` | `FRAME_att_a5` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a6` | `packages/game/src/m_berserk.ts` | `FRAME_att_a6` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a7` | `packages/game/src/m_berserk.ts` | `FRAME_att_a7` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a8` | `packages/game/src/m_berserk.ts` | `FRAME_att_a8` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a9` | `packages/game/src/m_berserk.ts` | `FRAME_att_a9` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a10` | `packages/game/src/m_berserk.ts` | `FRAME_att_a10` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a11` | `packages/game/src/m_berserk.ts` | `FRAME_att_a11` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a12` | `packages/game/src/m_berserk.ts` | `FRAME_att_a12` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_a13` | `packages/game/src/m_berserk.ts` | `FRAME_att_a13` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b1` | `packages/game/src/m_berserk.ts` | `FRAME_att_b1` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b2` | `packages/game/src/m_berserk.ts` | `FRAME_att_b2` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b3` | `packages/game/src/m_berserk.ts` | `FRAME_att_b3` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b4` | `packages/game/src/m_berserk.ts` | `FRAME_att_b4` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b5` | `packages/game/src/m_berserk.ts` | `FRAME_att_b5` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b6` | `packages/game/src/m_berserk.ts` | `FRAME_att_b6` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b7` | `packages/game/src/m_berserk.ts` | `FRAME_att_b7` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b8` | `packages/game/src/m_berserk.ts` | `FRAME_att_b8` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b9` | `packages/game/src/m_berserk.ts` | `FRAME_att_b9` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b10` | `packages/game/src/m_berserk.ts` | `FRAME_att_b10` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b11` | `packages/game/src/m_berserk.ts` | `FRAME_att_b11` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b12` | `packages/game/src/m_berserk.ts` | `FRAME_att_b12` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b13` | `packages/game/src/m_berserk.ts` | `FRAME_att_b13` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b14` | `packages/game/src/m_berserk.ts` | `FRAME_att_b14` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b15` | `packages/game/src/m_berserk.ts` | `FRAME_att_b15` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b16` | `packages/game/src/m_berserk.ts` | `FRAME_att_b16` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b17` | `packages/game/src/m_berserk.ts` | `FRAME_att_b17` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b18` | `packages/game/src/m_berserk.ts` | `FRAME_att_b18` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b19` | `packages/game/src/m_berserk.ts` | `FRAME_att_b19` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b20` | `packages/game/src/m_berserk.ts` | `FRAME_att_b20` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_b21` | `packages/game/src/m_berserk.ts` | `FRAME_att_b21` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c1` | `packages/game/src/m_berserk.ts` | `FRAME_att_c1` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c2` | `packages/game/src/m_berserk.ts` | `FRAME_att_c2` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c3` | `packages/game/src/m_berserk.ts` | `FRAME_att_c3` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c4` | `packages/game/src/m_berserk.ts` | `FRAME_att_c4` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c5` | `packages/game/src/m_berserk.ts` | `FRAME_att_c5` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c6` | `packages/game/src/m_berserk.ts` | `FRAME_att_c6` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c7` | `packages/game/src/m_berserk.ts` | `FRAME_att_c7` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c8` | `packages/game/src/m_berserk.ts` | `FRAME_att_c8` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c9` | `packages/game/src/m_berserk.ts` | `FRAME_att_c9` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c10` | `packages/game/src/m_berserk.ts` | `FRAME_att_c10` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c11` | `packages/game/src/m_berserk.ts` | `FRAME_att_c11` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c12` | `packages/game/src/m_berserk.ts` | `FRAME_att_c12` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c13` | `packages/game/src/m_berserk.ts` | `FRAME_att_c13` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c14` | `packages/game/src/m_berserk.ts` | `FRAME_att_c14` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c15` | `packages/game/src/m_berserk.ts` | `FRAME_att_c15` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c16` | `packages/game/src/m_berserk.ts` | `FRAME_att_c16` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c17` | `packages/game/src/m_berserk.ts` | `FRAME_att_c17` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c18` | `packages/game/src/m_berserk.ts` | `FRAME_att_c18` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c19` | `packages/game/src/m_berserk.ts` | `FRAME_att_c19` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c20` | `packages/game/src/m_berserk.ts` | `FRAME_att_c20` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c21` | `packages/game/src/m_berserk.ts` | `FRAME_att_c21` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c22` | `packages/game/src/m_berserk.ts` | `FRAME_att_c22` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c23` | `packages/game/src/m_berserk.ts` | `FRAME_att_c23` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c24` | `packages/game/src/m_berserk.ts` | `FRAME_att_c24` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c25` | `packages/game/src/m_berserk.ts` | `FRAME_att_c25` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c26` | `packages/game/src/m_berserk.ts` | `FRAME_att_c26` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c27` | `packages/game/src/m_berserk.ts` | `FRAME_att_c27` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c28` | `packages/game/src/m_berserk.ts` | `FRAME_att_c28` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c29` | `packages/game/src/m_berserk.ts` | `FRAME_att_c29` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c30` | `packages/game/src/m_berserk.ts` | `FRAME_att_c30` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c31` | `packages/game/src/m_berserk.ts` | `FRAME_att_c31` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c32` | `packages/game/src/m_berserk.ts` | `FRAME_att_c32` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c33` | `packages/game/src/m_berserk.ts` | `FRAME_att_c33` | A verifier | A redecouper |  |
| `Quake-2-master/game/m_berserk.h` | macro | `FRAME_att_c34` | `packages/game/src/m_berserk.ts` | `FRAME_att_c34` | A verifier | A redecouper |  |
