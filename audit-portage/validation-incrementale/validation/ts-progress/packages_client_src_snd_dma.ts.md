...
- Les wrappers publics homonymes dans `sound-public.ts` restent proprietaires de `client/sound.h`; ils ne dupliquent pas l'ownership `client/snd_dma.c` de ce fichier.
