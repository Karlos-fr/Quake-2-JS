# Progress TS - packages/client/src/sound-public.ts
...
- 13 symboles `Ported` marques `Couvert C/H` via `client_sound.h.md`, qui les marque `Valide` avec `packages/client/src/sound-public.ts` comme proprietaire TS attendu.
...
- Le doublon nominal avec `packages/client/src/snd_dma.ts` est intentionnel: `sound-public.ts` porte l'API publique de `client/sound.h`, tandis que `snd_dma.ts` reste proprietaire du backend `client/snd_dma.c`.
