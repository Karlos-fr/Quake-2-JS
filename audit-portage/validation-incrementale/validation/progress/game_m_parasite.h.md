...
- Continuer avec `FRAME_pain101` a `FRAME_pain111`, puis `FRAME_run01` a `FRAME_run15` si le lot reste coherent.
...
- `Prochain lot`: `Continuer avec FRAME_pain101 a FRAME_pain111, puis FRAME_run01 a FRAME_run15 si le lot reste coherent.`
