...
- Aucune ligne `A verifier` restante dans `game_q_shared.h.md`. Prochain travail recommande: decision explicite sur les 73 `MZ2_*` Rogue `Partiel` (porter les producteurs gameplay Rogue carrier/widow/stalker/daedalus/turret correspondants, ou confirmer l'exclusion Rogue) avant de passer le fichier en `Termine`.
