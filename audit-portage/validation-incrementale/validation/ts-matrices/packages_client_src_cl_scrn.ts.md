...
| `packages/client/src/cl_scrn.ts` | interface | `ClientTileClearCommand` | oui | `N/A` | `N/A (renderer-neutral screen DTO)` | New |  | TS sans lien source | Valide |  |
| `packages/client/src/cl_scrn.ts` | interface | `ClientScreenConsolePlan` | oui | `N/A` | `N/A (renderer-neutral screen DTO)` | New |  | TS sans lien source | Valide |  |
...
| `packages/client/src/cl_scrn.ts` | function | `SCR_TileClear` | oui | `SCR_TileClear` | `Quake-2-master/client/cl_scrn.c` | Ported | [`client_cl_scrn.c.md`](../matrices/client_cl_scrn.c.md) | Couvert C/H | Couvert C/H |  |
| `packages/client/src/cl_scrn.ts` | function | `SCR_TileClearRef` | oui | `SCR_TileClear` | `Quake-2-master/client/cl_scrn.c` | Adapter | [`client_cl_scrn.c.md`](../matrices/client_cl_scrn.c.md) | Doublon resolu | Valide | Adapter `refexport_t`; proprietaire portage: `SCR_TileClear`. |
| `packages/client/src/cl_scrn.ts` | function | `SCR_DrawConsole` | oui | `SCR_DrawConsole` | `Quake-2-master/client/cl_scrn.c` | Ported | [`client_cl_scrn.c.md`](../matrices/client_cl_scrn.c.md) | Couvert C/H | Couvert C/H |  |
