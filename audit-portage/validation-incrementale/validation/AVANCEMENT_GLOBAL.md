...
| `Quake-2-master/game/g_cmds.c` | [`game_g_cmds.c.md`](matrices/game_g_cmds.c.md) | [`game_g_cmds.c.md`](progress/game_g_cmds.c.md) | En cours | 74 | 67 | 0 | 0 | 0 | 0 | `Cmd_PlayerList_f` et temporaires `i`, `st`, `text`, `e2` | Haute |
...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 54 | 0 | 0 | 0 | 0 | `button_killed` | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 34 | 0 | 0 | 0 | 0 | `G_FreeEdict`, puis `drop_temp_touch` si coherent | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 59 | 0 | 0 | 0 | 1 | `AI_MEDIC`, `AI_RESURRECTING` | Haute |
| `Quake-2-master/game/g_main.c` | [`game_g_main.c.md`](matrices/game_g_main.c.md) | [`game_g_main.c.md`](progress/game_g_main.c.md) | En cours | 75 | 29 | 7 | 0 | 0 | 0 | `ClientThink` | Haute |
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 9 | 0 | 0 | 0 | 0 | `gib` / `vscale`, puis `ThrowHead` | Haute |
