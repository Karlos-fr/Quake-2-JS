...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 52 | 0 | 0 | 0 | 74 | `CL_TrapParticles` avec les locaux `move`, `vec`, `len`, `j`, `dec`, `vel`, `dir` et `org`; garder `CL_BFGExplosionParticles` et `CL_TeleportParticles` pour des sessions separees si le lot devient trop large. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par petite famille `m_*` non reservee des consommateurs runtime de `random`/`crandom`; `m_flyer.ts` vient d'etre migre/verifie, prochain lot recommande `m_chick.ts` ou `m_gladiator.ts`. | Haute |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | Partiel | 37 | 17 | 2 | 0 | 0 | 18 | Reprendre les blocages separes `vectoyaw` -> `p_trail.ts` ou `vectoangles` -> `g_weapon.ts`, un fichier cible par session. | Haute |
...
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 50 | 0 | 0 | 0 | 0 | Valider le bloc mort `actor_dead`, `actor_frames_death1`/`actor_move_death1`, `actor_frames_death2`/`actor_move_death2`, `actor_die` et le local `n`, avec bbox finale, gib/death branches, frames visibles et sortie renderer. | Haute |
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) |  | A demarrer | 482 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 28 | 0 | 0 | 0 | 1 | Valider le bloc `berserk_attack_spike` / `berserk_swing` / `berserk_frames_attack_spike` / `berserk_move_attack_spike`, en couvrant le son, `fire_hit`, l'endfunc `berserk_run`, les callbacks de frames et les sorties visibles/audibles runtime. | Haute |
| `Quake-2-master/game/m_berserk.h` | [`game_m_berserk.h.md`](matrices/game_m_berserk.h.md) |  | A demarrer | 245 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss2.c` | [`game_m_boss2.c.md`](matrices/game_m_boss2.c.md) | [`game_m_boss2.c.md`](progress/game_m_boss2.c.md) | En cours | 78 | 23 | 0 | 0 | 0 | 0 | Valider le bloc attaque machinegun: `boss2_attack`, local `range`, `boss2_attack_mg`, `boss2_reattack_mg`, puis les tables/moves `boss2_frames_attack_pre_mg`, `boss2_move_attack_pre_mg`, `boss2_frames_attack_mg`, `boss2_move_attack_mg`, `boss2_frames_attack_post_mg`, `boss2_move_attack_post_mg` si le lot reste raisonnable. | Haute |
