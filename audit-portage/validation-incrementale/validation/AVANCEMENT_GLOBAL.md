...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 38 | 0 | 0 | 0 | 15 | `CL_BlasterTrail`, puis les locaux `move`, `vec`, `len`, `j` et `dec` si le lot reste coherent. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par famille non reservee des consommateurs runtime de `random`/`crandom` (`g_func.ts` et `g_target.ts` deja migres); reprendre `g_turret.ts`, `g_utils.ts`, `g_weapon.ts` quand ils ne sont plus reserves. | Haute |
...
| `Quake-2-master/game/g_turret.c` | [`game_g_turret.c.md`](matrices/game_g_turret.c.md) | [`game_g_turret.c.md`](progress/game_g_turret.c.md) | En cours | 23 | 11 | 0 | 0 | 0 | 10 | `SP_turret_driver`. | Haute |
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 9 | 0 | 0 | 0 | 9 | `G_SetMovedir` si le coordinateur garde le lot dans `g_utils.ts`; clarifier separement la ligne globale `v` pointee vers `g_weapon.ts`. | Haute |
...
| `Quake-2-master/game/game.h` | [`game_game.h.md`](matrices/game_game.h.md) | [`game_game.h.md`](progress/game_game.h.md) | En cours | 30 | 23 | 0 | 0 | 0 | 0 | `game_import_t`, a traiter seul ou avec une petite famille de callbacks si le lot reste lisible. | Haute |
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 2 | 0 | 0 | 0 | 0 | Valider le bloc stand: `actor_frames_stand` (lignes global/table dupliquees), `actor_move_stand`, puis `actor_stand` si le lot reste petit. | Haute |
