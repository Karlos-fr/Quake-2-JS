...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 83 | 0 | 0 | 0 | 1 | Continuer avec `TRAIN_START_ON`, `TRAIN_TOGGLE`, `TRAIN_BLOCK_STOPS`, puis `train_next` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 82 | 0 | 0 | 0 | 0 | Reprendre la prochaine entree `A verifier` restante de `game_g_items.c.md` dans l'ordre de la matrice: `Pickup_Adrenaline`. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 128 | 0 | 0 | 0 | 1 | Continuer avec `game_locals_t`, puis les champs `helpmessage1`, `helpmessage2`, `helpchanged` si le lot reste raisonnable. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 52 | 0 | 0 | 0 | 0 | `barrel_touch` avec le local `ratio` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 17 | 0 | 0 | 0 | 0 | `M_WorldEffects` avec locale `dmg` si le lot reste petit | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | En cours | 64 | 10 | 0 | 0 | 0 | 0 | `STOP_EPSILON` et `ClipVelocity` avec locales `backoff` / `change` si le lot reste petit. | Haute |
