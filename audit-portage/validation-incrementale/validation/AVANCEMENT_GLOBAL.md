...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 80 | 0 | 0 | 0 | 1 | Continuer avec `SP_func_door`. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 79 | 0 | 0 | 0 | 0 | Reprendre les prochaines entrees `A verifier` restantes de `game_g_items.c.md` dans l'ordre de la matrice: `SetRespawn`, puis `Pickup_Powerup` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 112 | 0 | 0 | 0 | 1 | Continuer avec la structure `gitem_s` et le prochain petit groupe de champs associes (`classname`, `pickup_sound`, `world_model`, `world_model_flags`, `view_model`) si le lot reste raisonnable. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 41 | 0 | 0 | 0 | 0 | `func_object_touch` / `func_object_release` / `func_object_use` / `SP_func_object`. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 10 | 0 | 0 | 0 | 0 | `AttackFinished` | Haute |
