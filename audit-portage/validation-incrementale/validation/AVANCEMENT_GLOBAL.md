...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 140 | 0 | 0 | 0 | 1 | Bloc angle move: `AngleMove_Done`, `AngleMove_Final`, puis `AngleMove_Begin` / `AngleMove_Calc` et leurs locales si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 187 | 0 | 0 | 0 | 1 | Continuer `moveinfo_t` avec `sound_start`, `sound_middle`, `sound_end`, puis `accel`, `speed`, `decel`, `distance` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 94 | 0 | 0 | 0 | 0 | `SP_light_mine1` et `SP_light_mine2` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 44 | 0 | 0 | 0 | 0 | `swimmonster_start`. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 3 | 0 | 0 | 0 | 0 | `levelfields` global/table, puis `clientfields` global/table si le lot reste petit. | Haute |
