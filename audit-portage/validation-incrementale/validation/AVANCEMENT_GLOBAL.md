...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 34 | 0 | 0 | 0 | 11 | `CL_TeleporterParticles` avec ses temporaires locaux associes si le lot reste coherent. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 0 | 0 | 0 | 1 | `random`, puis `crandom` si coherent. | Haute |
...
| `Quake-2-master/game/g_turret.c` | [`game_g_turret.c.md`](matrices/game_g_turret.c.md) | [`game_g_turret.c.md`](progress/game_g_turret.c.md) | En cours | 23 | 5 | 0 | 0 | 0 | 7 | `turret_breach_finish_init`, puis `SP_turret_breach` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 3 | 0 | 0 | 0 | 2 | `MAXCHOICES`, puis `G_PickTarget` et les locaux `ent`, `num_choices`, `choice` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 15 | 0 | 0 | 0 | 45 | `bfg_touch` seul. | Haute |
| `Quake-2-master/game/game.h` | [`game_game.h.md`](matrices/game_game.h.md) | [`game_game.h.md`](progress/game_game.h.md) | En cours | 29 | 7 | 0 | 0 | 0 | 0 | `gclient_s`, puis `ps` et `ping` si le lot reste petit. | Haute |
