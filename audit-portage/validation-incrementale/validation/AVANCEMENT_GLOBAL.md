...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 35 | 0 | 0 | 0 | 11 | `CL_ExplosionParticles`. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Migrer/justifier les consommateurs runtime de `random`/`crandom`, puis reprendre le prochain lot distinct. | Haute |
...
| `Quake-2-master/game/g_turret.c` | [`game_g_turret.c.md`](matrices/game_g_turret.c.md) | [`game_g_turret.c.md`](progress/game_g_turret.c.md) | En cours | 23 | 7 | 0 | 0 | 0 | 7 | `SP_turret_base`, puis `turret_driver_die` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 5 | 0 | 0 | 0 | 5 | `Think_Delay`, puis `G_UseTargets` et le local `t` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 16 | 0 | 0 | 0 | 45 | `bfg_think` seul, avec ses temporaires locaux si le lot reste compact. | Haute |
| `Quake-2-master/game/game.h` | [`game_game.h.md`](matrices/game_game.h.md) | [`game_game.h.md`](progress/game_game.h.md) | En cours | 29 | 10 | 0 | 0 | 0 | 0 | `edict_s`, puis `s`, `client` et `inuse` si le lot reste petit. | Haute |
