...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 229 | 0 | 0 | 0 | 1 | Continuer avec `body_armor_index`, puis les macros MOD a partir de `MOD_UNKNOWN` si le lot reste petit, avec preuves de consommation armor/combat et means-of-death runtime. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 39 | 0 | 0 | 0 | 0 | Continuer avec `WriteLevel`, puis ses temporaires locaux `i` et `ent` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 29 | 13 | 0 | 0 | 0 | 8 | Continuer avec `G_FindTeams`. | Haute |
...
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 43 | 0 | 0 | 0 | 0 | `target_laser_start`, le local `ent`, la ligne dupliquee `target_laser_off` et `SP_target_laser` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 7 | 0 | 0 | 0 | 25 | `Grenade_Explode` avec `origin`, `mod` et `points` si le lot reste coherent. | Haute |
