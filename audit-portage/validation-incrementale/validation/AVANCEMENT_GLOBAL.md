...
| `Quake-2-master/game/g_ai.c` | [`game_g_ai.c.md`](matrices/game_g_ai.c.md) | [`game_g_ai.c.md`](progress/game_g_ai.c.md) | En cours | 48 | 9 | 0 | 0 | 0 | 3 | `ai_charge` separement | Haute |
| `Quake-2-master/game/g_chase.c` | [`game_g_chase.c.md`](matrices/game_g_chase.c.md) | [`game_g_chase.c.md`](progress/game_g_chase.c.md) | En cours | 14 | 3 | 0 | 0 | 0 | 8 | `GetChaseTarget` et locales `i`/`other` | Haute |
| `Quake-2-master/game/g_cmds.c` | [`game_g_cmds.c.md`](matrices/game_g_cmds.c.md) | [`game_g_cmds.c.md`](progress/game_g_cmds.c.md) | En cours | 74 | 19 | 0 | 0 | 0 | 0 | `Cmd_God_f` et temporaires `msg` | Haute |
| `Quake-2-master/game/g_combat.c` | [`game_g_combat.c.md`](matrices/game_g_combat.c.md) | [`game_g_combat.c.md`](progress/game_g_combat.c.md) | En cours | 36 | 4 | 0 | 0 | 0 | 0 | `CheckPowerArmor` et variables associees | Haute |
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 16 | 0 | 0 | 0 | 0 | mouvement accelere `Think_AccelMove`/`Move_Calc` | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 2 | 0 | 0 | 0 | 0 | `Drop_Weapon` | Haute |
