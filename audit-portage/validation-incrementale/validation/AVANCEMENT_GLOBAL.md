...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 40 | 0 | 0 | 0 | 25 | `CL_FlagTrail`, puis les locaux `move`, `vec`, `len`, `j` et `dec` si le lot reste coherent. | Normale |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 10 | 1 | 0 | 0 | 10 | `vectoangles` avec ses locaux `forward`, `pitch` et `yaw` si le lot reste petit; `vectoyaw` reste partiel tant que `p_trail.ts` garde son doublon prive; clarifier separement la ligne globale `v` pointee vers `g_weapon.ts`. | Haute |
...
| `Quake-2-master/game/game.h` | [`game_game.h.md`](matrices/game_game.h.md) | [`game_game.h.md`](progress/game_game.h.md) | En cours | 30 | 25 | 0 | 0 | 0 | 0 | `apiversion` seul, puis `edict_size`, `num_edicts` et `max_edicts` dans un lot separe si coherent. | Haute |
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 13 | 0 | 0 | 0 | 0 | Valider le bloc run: `actor_frames_run` (lignes global/table/declarative), `actor_move_run`, puis `actor_run` si le lot reste petit. | Haute |
