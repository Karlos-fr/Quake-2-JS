...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer les consommateurs restants de `random`/`crandom`: `m_brain.ts`, `m_float.ts`, `m_flyer.ts`, `m_gladiator.ts`, `m_medic.ts`, `m_parasite.ts` verifies, `m_flipper.ts` confirme hors macros; prochain lot recommande `g_utils.ts` si libre, ou fichiers monstres restants non reserves. | Haute |
...
| `Quake-2-master/game/m_boss31.c` | [`game_m_boss31.c.md`](matrices/game_m_boss31.c.md) | [`game_m_boss31.c.md`](progress/game_m_boss31.c.md) | En cours | 103 | 89 | 0 | 0 | 0 | 13 | `SP_monster_jorg`, seule entree restante `A verifier` dans la matrice. | Haute |
| `Quake-2-master/game/m_boss31.h` | [`game_m_boss31.h.md`](matrices/game_m_boss31.h.md) |  | A demarrer | 189 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss32.c` | [`game_m_boss32.c.md`](matrices/game_m_boss32.c.md) | [`game_m_boss32.c.md`](progress/game_m_boss32.c.md) | En cours | 110 | 80 | 0 | 0 | 0 | 12 | `makron_torso_think`, `makron_torso`, `makron_dead`, `makron_die`, avec `tempent`/`n` si coherent. | Haute |
