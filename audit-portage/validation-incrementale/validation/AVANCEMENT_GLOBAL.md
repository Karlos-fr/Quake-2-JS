...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 93 | 0 | 0 | 0 | 1 | Continuer avec les locales matricielles restantes de `train_next` (`ent`, `dest`, `first`), puis `train_resume` avec sa locale `ent` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 84 | 0 | 0 | 0 | 0 | Reprendre la prochaine entree `A verifier` restante de `game_g_items.c.md` dans l'ordre de la matrice: `Pickup_Bandolier`, avec la locale `item` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 136 | 0 | 0 | 0 | 1 | Continuer avec les champs restants de `game_locals_t`: `num_items` et `autosaved`, puis clore la tranche `game_locals_t` si le lot reste raisonnable. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 56 | 0 | 0 | 0 | 0 | `barrel_delay`, puis `SP_misc_explobox` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 22 | 0 | 0 | 0 | 0 | `M_SetEffects`. | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | En cours | 64 | 19 | 0 | 0 | 0 | 0 | Continuer `SV_FlyMove` avec les locales `numplanes`, `planes`, `trace`, `end`, `time_left` et `blocked` si le lot reste petit. | Haute |
