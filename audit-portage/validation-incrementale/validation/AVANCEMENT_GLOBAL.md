...
| `Quake-2-master/game/g_ai.c` | [`game_g_ai.c.md`](matrices/game_g_ai.c.md) | [`game_g_ai.c.md`](progress/game_g_ai.c.md) | En cours | 48 | 19 | 0 | 0 | 0 | 10 | `M_CheckAttack` avec locales `chance`, `tr` | Haute |
...
| `Quake-2-master/game/g_cmds.c` | [`game_g_cmds.c.md`](matrices/game_g_cmds.c.md) | [`game_g_cmds.c.md`](progress/game_g_cmds.c.md) | En cours | 74 | 39 | 0 | 0 | 0 | 0 | `Cmd_WeapPrev_f` avec temporaires `it`, `selected_weapon` | Haute |
| `Quake-2-master/game/g_combat.c` | [`game_g_combat.c.md`](matrices/game_g_combat.c.md) | [`game_g_combat.c.md`](progress/game_g_combat.c.md) | En cours | 36 | 21 | 1 | 0 | 0 | 0 | callbacks pain et accumulation finale `client.damage_*` | Haute |
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 45 | 0 | 0 | 0 | 0 | `rotating_touch` | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 9 | 0 | 0 | 0 | 0 | `Weapon_RocketLauncher` | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 29 | 0 | 0 | 0 | 1 | `TAG_GAME`, `TAG_LEVEL` | Haute |
