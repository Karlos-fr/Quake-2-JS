...
| `Quake-2-master/game/g_ai.c` | [`game_g_ai.c.md`](matrices/game_g_ai.c.md) | [`game_g_ai.c.md`](progress/game_g_ai.c.md) | En cours | 48 | 25 | 1 | 0 | 0 | 16 | finir `ai_run`: `AI_LOST_SIGHT`/`PlayerTrail`, locales `tempgoal`, `save`, `new`/`isNew`, `marker`, `tr` | Haute |
...
| `Quake-2-master/game/g_cmds.c` | [`game_g_cmds.c.md`](matrices/game_g_cmds.c.md) | [`game_g_cmds.c.md`](progress/game_g_cmds.c.md) | En cours | 74 | 51 | 0 | 0 | 0 | 0 | `Cmd_PutAway_f` | Haute |
...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 50 | 0 | 0 | 0 | 0 | `button_wait` | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 14 | 0 | 0 | 0 | 0 | indices armure/power armor: `jacket_armor_index`, `combat_armor_index`, `body_armor_index`, `power_screen_index`, `power_shield_index` | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 44 | 0 | 0 | 0 | 1 | `GIB_ORGANIC`, `GIB_METALLIC` | Haute |
| `Quake-2-master/game/g_main.c` | [`game_g_main.c.md`](matrices/game_g_main.c.md) | [`game_g_main.c.md`](progress/game_g_main.c.md) | En cours | 75 | 10 | 5 | 0 | 0 | 0 | `g_select_empty`, `dedicated`, `filterban`, `sv_maxvelocity`, `sv_gravity`, `sv_rollspeed`, `sv_rollangle` | Haute |
