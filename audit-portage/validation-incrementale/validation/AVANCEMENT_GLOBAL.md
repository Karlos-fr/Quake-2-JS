...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 44 | 0 | 0 | 0 | 43 | `CL_RailTrail` seul, avec ses locaux `move`, `vec`, `len`, `j`, `dec`, `i`, `dir` et `clr` si la matrice les rattache au lot. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par famille non reservee des consommateurs runtime de `random`/`crandom` (`g_ai.ts`, `g_func.ts`, `g_target.ts`, `g_weapon.ts`, `g_misc.ts`, `g_turret.ts`, `g_monster.ts`, `p_weapon.ts` et `p_client.ts` deja migres; `g_items.ts`/`p_hud.ts` verifies hors macros); reprendre `g_utils.ts` quand il n'est plus reserve, ou passer a une petite famille `m_*`/`m_move.ts`. | Haute |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 14 | 2 | 0 | 0 | 14 | `G_TouchTriggers` seul, sans melanger `G_TouchSolids`, `KillBox` ni les lignes locales restantes; `vectoyaw` reste partiel tant que `p_trail.ts` garde son doublon prive; `vectoangles` reste partiel tant que `g_weapon.ts` garde son helper local; clarifier separement la ligne globale `v` pointee vers `g_weapon.ts`. | Haute |
...
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 34 | 0 | 0 | 0 | 0 | Valider le bloc taunt: `actor_frames_taunt` (lignes global/table/declarative) et `actor_move_taunt`, en gardant `messages` et `actor_pain` pour un lot separe si le lot devient trop large. | Haute |
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) |  | A demarrer | 482 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 14 | 0 | 0 | 0 | 1 | Valider le bloc stand fidget declaratif: `berserk_frames_stand_fidget` global/table/declarative et `berserk_move_stand_fidget`; garder les transitions walk/run pour une session separee si le lot devient trop large. | Haute |
| `Quake-2-master/game/m_berserk.h` | [`game_m_berserk.h.md`](matrices/game_m_berserk.h.md) |  | A demarrer | 245 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss2.c` | [`game_m_boss2.c.md`](matrices/game_m_boss2.c.md) | [`game_m_boss2.c.md`](progress/game_m_boss2.c.md) | En cours | 78 | 6 | 0 | 0 | 0 | 0 | `boss2_run` seul, avec la branche `AI_STAND_GROUND`, les affectations `boss2_move_stand` / `boss2_move_run`, et le branchement `monsterinfo.run`; garder attaques, frames et moves pour des sessions separees. | Haute |
