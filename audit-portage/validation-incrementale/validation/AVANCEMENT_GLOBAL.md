...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 89 | 0 | 0 | 0 | 1 | Continuer avec `train_blocked`, puis `train_wait` et ses locales `savetarget`/`ent` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 83 | 0 | 0 | 0 | 0 | Reprendre la prochaine entree `A verifier` restante de `game_g_items.c.md` dans l'ordre de la matrice: `Pickup_AncientHead`. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 132 | 0 | 0 | 0 | 1 | Continuer avec les champs restants de `game_locals_t`: `spawnpoint`, `maxclients`, `maxentities`, puis `serverflags` si le lot reste raisonnable. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 54 | 0 | 0 | 0 | 0 | `barrel_explode` avec le local `spd` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 19 | 0 | 0 | 0 | 0 | `M_droptofloor` avec locales `end` et `trace` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | En cours | 64 | 14 | 0 | 0 | 0 | 0 | `MAX_CLIP_PLANES`, puis debuter `SV_FlyMove` avec les locales `hit`, `dir` et `d` si le lot reste petit. | Haute |
