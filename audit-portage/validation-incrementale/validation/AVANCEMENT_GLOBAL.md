...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 45 | 0 | 0 | 0 | 51 | `CL_IonripperTrail` seul, avec ses locaux `len`, `j`, `dec` et `left` si la matrice les rattache au lot; garder `CL_BubbleTrail` et les effets `BEAMLENGTH` pour des sessions separees. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par petite famille `m_*` non reservee des consommateurs runtime de `random`/`crandom` (`g_ai.ts`, `g_func.ts`, `g_target.ts`, `g_weapon.ts`, `g_misc.ts`, `g_turret.ts`, `g_monster.ts`, `p_weapon.ts`, `p_client.ts` et `m_brain.ts` deja migres; `m_move.ts`, `g_items.ts` et `p_hud.ts` verifies hors macros); reprendre `g_utils.ts` quand il n'est plus reserve. | Haute |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 15 | 2 | 0 | 0 | 14 | `G_TouchSolids` seul, sans melanger `KillBox` ni les lignes locales restantes; `vectoyaw` reste partiel tant que `p_trail.ts` garde son doublon prive; `vectoangles` reste partiel tant que `g_weapon.ts` garde son helper local; clarifier separement la ligne globale `v` pointee vers `g_weapon.ts`. | Haute |
...
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 38 | 0 | 0 | 0 | 0 | Valider `messages`, puis `actor_pain` dans un lot separe si cela reste raisonnable; garder les lignes locales `n`/`name` avec le lot `actor_pain` si elles lui sont rattachees. | Haute |
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) |  | A demarrer | 482 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 18 | 0 | 0 | 0 | 1 | Valider le bloc walk declaratif: `berserk_frames_walk` global/table/declarative et `berserk_move_walk`; garder `berserk_walk` / run pour une session separee si le lot devient trop large. | Haute |
| `Quake-2-master/game/m_berserk.h` | [`game_m_berserk.h.md`](matrices/game_m_berserk.h.md) |  | A demarrer | 245 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss2.c` | [`game_m_boss2.c.md`](matrices/game_m_boss2.c.md) | [`game_m_boss2.c.md`](progress/game_m_boss2.c.md) | En cours | 78 | 8 | 0 | 0 | 0 | 0 | `boss2_stand` seul, avec l'affectation `boss2_move_stand` et le branchement `monsterinfo.stand`; garder les tables `boss2_frames_stand` / `boss2_move_stand` pour un lot declaratif separe si la session doit rester minimale. | Haute |
