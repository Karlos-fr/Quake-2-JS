...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 623 | 332 | 0 | 0 | 0 | 39 | Continuer au bloc prototypes `g_monster.c`, de `monster_fire_bullet` a `M_CheckGround`, puis les prochaines constantes/globals proprietaires apres ce bloc. | Haute |
