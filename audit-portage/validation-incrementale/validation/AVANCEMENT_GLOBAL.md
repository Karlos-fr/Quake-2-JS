...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 623 | 419 | 0 | 0 | 0 | 119 | Commencer `edict_s` avec `edict_s`, `s`, `inuse`, `linkcount`, `area`, `num_clusters`, `clusternums`, `headnode`, `svflags`, `solid`, `clipmask`, `owner`, `movetype`, `flags`, `model` si le lot reste coherent. | Haute |
