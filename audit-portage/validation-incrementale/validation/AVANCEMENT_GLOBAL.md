...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 623 | 207 | 0 | 0 | 0 | 1 | Continuer avec `mmove_t`, `firstframe`, `lastframe`, `frame` et le callback `endfunc` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 107 | 0 | 0 | 0 | 0 | `func_clock_think`, local `gmtime`, locals `savetarget`/`savemessage`, puis `func_clock_use` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 12 | 0 | 0 | 0 | 0 | `WriteField2` si le lot reste centre sur l'ecriture des chaines apres la premiere passe. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 135 | 14 | 0 | 0 | 0 | 0 | `SP_func_door_secret`, `SP_func_door_rotating`, `SP_func_water` et `SP_func_train` si le lot reste raisonnable. | Haute |
| `Quake-2-master/game/g_svcmds.c` | [`game_g_svcmds.c.md`](matrices/game_g_svcmds.c.md) | [`game_g_svcmds.c.md`](progress/game_g_svcmds.c.md) | En cours | 29 | 10 | 0 | 0 | 0 | 0 | `SV_FilterPacket` et ses locaux `i`, `in`, `m`, `p` si le lot reste centre sur le filtrage d'adresse entrante. | Haute |
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 59 | 11 | 0 | 0 | 0 | 0 | `use_target_secret` et `SP_target_secret` si le lot reste petit. | Haute |
