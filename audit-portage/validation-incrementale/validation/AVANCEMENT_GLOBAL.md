...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 36 | 0 | 0 | 0 | 11 | `CL_BigTeleportParticles`, puis les locaux `i` et `colortable` si le lot reste coherent. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Migrer par famille non reservee les consommateurs runtime de `random`/`crandom`; reprendre `g_turret.ts`, `g_utils.ts`, `g_weapon.ts` quand ils ne sont plus reserves. | Haute |
...
| `Quake-2-master/game/g_turret.c` | [`game_g_turret.c.md`](matrices/game_g_turret.c.md) | [`game_g_turret.c.md`](progress/game_g_turret.c.md) | En cours | 23 | 9 | 0 | 0 | 0 | 8 | `turret_driver_think` et le local `reaction_time` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 7 | 0 | 0 | 0 | 6 | `tv`, puis le local `index` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 17 | 0 | 0 | 0 | 50 | `fire_bfg` seul et son temporaire local `bfg`. | Haute |
| `Quake-2-master/game/game.h` | [`game_game.h.md`](matrices/game_game.h.md) | [`game_game.h.md`](progress/game_game.h.md) | En cours | 30 | 14 | 0 | 0 | 0 | 0 | `linkcount`, puis `area`, `num_clusters` et `clusternums` si le lot reste coherent. | Haute |
