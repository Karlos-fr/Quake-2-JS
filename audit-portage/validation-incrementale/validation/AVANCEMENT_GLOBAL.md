...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | Termine | 150 | 149 | 0 | 0 | 0 | 1 | Aucun. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | Termine | 109 | 109 | 0 | 0 | 0 | 0 | Aucun lot restant dans cette matrice: toutes les lignes sont `Valide`. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 624 | 220 | 0 | 0 | 0 | 1 | Continuer avec `monsterinfo_t.search_time`, `trail_time` et `last_sighting` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | Termine | 119 | 119 | 0 | 0 | 0 | 0 | Aucun lot restant dans cette matrice: toutes les lignes sont `Valide`. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | Termine | 45 | 45 | 0 | 0 | 0 | 0 | Aucun lot restant dans cette matrice: toutes les lignes sont `Valide`. | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | Termine | 64 | 64 | 0 | 0 | 0 | 0 | Aucun lot restant dans cette matrice: toutes les lignes sont `Valide`. | Haute |
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 21 | 0 | 0 | 0 | 0 | Continuer avec `ReadClient`, puis son temporaire local `field` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 135 | 25 | 0 | 0 | 0 | 0 | `SP_func_clock` dans un lot separe rattache a `packages/game/src/g_misc.ts`. | Haute |
| `Quake-2-master/game/g_svcmds.c` | [`game_g_svcmds.c.md`](matrices/game_g_svcmds.c.md) | [`game_g_svcmds.c.md`](progress/game_g_svcmds.c.md) | En cours | 29 | 21 | 0 | 0 | 0 | 0 | `SVCmd_WriteIP_f`, puis ses locaux `name`, `b`, `i`, `game` et l'adaptation `sprintf` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 59 | 21 | 0 | 0 | 0 | 0 | `use_target_splash` et `SP_target_splash` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_trigger.c` | [`game_g_trigger.c.md`](matrices/game_g_trigger.c.md) | [`game_g_trigger.c.md`](progress/game_g_trigger.c.md) | En cours | 33 | 8 | 0 | 0 | 0 | 1 | Continuer avec `trigger_relay_use` et `SP_trigger_relay`, puis `trigger_key_use`/`SP_trigger_key` si le lot reste petit. | Haute |
