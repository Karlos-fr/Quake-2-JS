...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 13 | 0 | 0 | 0 | 4 | `cl_dlights`, `CL_ClearDlights`, `CL_AllocDlight`, `CL_NewDlight`, `CL_RunDLights`, `CL_AddDLights` si le lot reste raisonnable; reduire a clear/alloc si besoin. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 222 | 0 | 0 | 0 | 1 | Continuer avec `monsterinfo_t.linkcount`, puis `power_armor_type` et `power_armor_power` si le lot reste petit, avec preuves monster link/save et power armor runtime. | Haute |
| `Quake-2-master/game/g_main.c` | [`game_g_main.c.md`](matrices/game_g_main.c.md) | [`game_g_main.c.md`](progress/game_g_main.c.md) | Partiel | 62 | 28 | 7 | 0 | 0 | 1 | Continuer avec le prochain symbole `g_main.c` dans la matrice: `ReadLevel`. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 30 | 0 | 0 | 0 | 0 | Continuer avec `WriteEdict`, puis ses temporaires locaux `field` et `temp` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 31 | 7 | 0 | 0 | 0 | 0 | Continuer avec un sous-lot explicite de `spawns` centre sur la table/ownership, sans valider les fonctions externes deja proprietaires de `g_misc.c`, `g_func.c`, `p_client.c` ou `g_items.c`; sinon passer a `ED_CallSpawn`. | Haute |
...
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 30 | 0 | 0 | 0 | 0 | `trigger_crosslevel_trigger_use` et `SP_target_crosslevel_trigger`, puis les entites `target_crosslevel_target_*` dans un lot separe si necessaire. | Haute |
| `Quake-2-master/game/g_trigger.c` | [`game_g_trigger.c.md`](matrices/game_g_trigger.c.md) | [`game_g_trigger.c.md`](progress/game_g_trigger.c.md) | En cours | 33 | 19 | 0 | 0 | 0 | 5 | Continuer avec `hurt_use`, `hurt_touch`, les temporaires locaux `dflags` et `SP_trigger_hurt` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_turret.c` | [`game_g_turret.c.md`](matrices/game_g_turret.c.md) |  | A demarrer | 23 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) |  | A demarrer | 37 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 2 | 0 | 0 | 0 | 8 | `fire_lead` et ses temporaires locaux (`tr`, `dir`, `end`, `r`, `u`, `water_start`, `water`, `content_mask`, `color`) si le lot reste petit; sinon limiter aux branches trace/impact sans eau. | Haute |
...
| `Quake-2-master/game/m_boss2.c` | [`game_m_boss2.c.md`](matrices/game_m_boss2.c.md) |  | A demarrer | 78 | 0 | 0 | 0 | 0 | 0 |  | Haute |
...
| `Quake-2-master/qcommon/common.c` | [`qcommon_common.c.md`](matrices/qcommon_common.c.md) |  | A demarrer | 150 | 0 | 0 | 0 | 0 | 0 |  | Haute |
