...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 39 | 0 | 0 | 0 | 20 | `CL_QuadTrail`, puis les locaux `move`, `vec`, `len`, `j` et `dec` si le lot reste coherent. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par famille non reservee des consommateurs runtime de `random`/`crandom` (`g_func.ts`, `g_target.ts` et `g_weapon.ts` deja migres); reprendre `g_turret.ts` et `g_utils.ts` quand ils ne sont plus reserves. | Haute |
...
| `Quake-2-master/game/g_turret.c` | [`game_g_turret.c.md`](matrices/game_g_turret.c.md) | [`game_g_turret.c.md`](progress/game_g_turret.c.md) | En cours | 23 | 12 | 0 | 0 | 0 | 10 | Clarifier la seconde ligne `attacker` encore `A verifier` dans la matrice. | Haute |
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 10 | 0 | 0 | 0 | 9 | `vectoyaw` avec son local `yaw` si le lot reste petit; clarifier separement la ligne globale `v` pointee vers `g_weapon.ts`. | Haute |
...
| `Quake-2-master/game/game.h` | [`game_game.h.md`](matrices/game_game.h.md) | [`game_game.h.md`](progress/game_game.h.md) | En cours | 30 | 24 | 0 | 0 | 0 | 0 | `game_export_t`, puis `apiversion` si le lot reste petit. | Haute |
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 8 | 0 | 0 | 0 | 0 | Valider le bloc walk: `actor_frames_walk` (lignes global/table/declarative), `actor_move_walk`, puis `actor_walk` si le lot reste petit. | Haute |
