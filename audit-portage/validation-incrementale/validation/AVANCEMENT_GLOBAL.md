...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 194 | 0 | 0 | 0 | 1 | Continuer `moveinfo_t` avec `wait`, `state`, `dir`, puis `current_speed`, `move_speed`, `next_speed` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 96 | 0 | 0 | 0 | 0 | `SP_misc_gib_arm`, `SP_misc_gib_leg` et `SP_misc_gib_head` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 7 | 0 | 0 | 0 | 0 | `InitGame`, sans inclure `WriteField1` dans le meme petit lot sauf preuve de branchement strictement necessaire. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 135 | 2 | 0 | 0 | 0 | 0 | `SP_item_health`, `SP_item_health_small`, `SP_item_health_large` et `SP_item_health_mega`. | Haute |
