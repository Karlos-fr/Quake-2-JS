...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 57 | 0 | 0 | 0 | 87 | `CL_EntityEvent` seul, en validant tous les cas d'evenements et les sons/particules associes. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par famille `m_*` non reservee des consommateurs runtime de `random`/`crandom`; `m_gunner.ts` vient d'etre migre/verifie, prochain lot recommande `m_chick.ts`, `m_infantry.ts` ou `m_hover.ts`. | Haute |
...
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 40 | 0 | 0 | 0 | 1 | Valider le bloc attaque strike `berserk_strike`, `berserk_frames_attack_strike`, `berserk_move_attack_strike`, avec `berserk_swing`, `endfunc = berserk_run` et justification du FIXME impact sound. | Haute |
| `Quake-2-master/game/m_berserk.h` | [`game_m_berserk.h.md`](matrices/game_m_berserk.h.md) |  | A demarrer | 245 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss2.c` | [`game_m_boss2.c.md`](matrices/game_m_boss2.c.md) | [`game_m_boss2.c.md`](progress/game_m_boss2.c.md) | En cours | 78 | 46 | 0 | 0 | 0 | 1 | Valider le bloc douleur restant `boss2_pain`, `boss2_frames_pain_heavy`, `boss2_move_pain_heavy`, `boss2_frames_pain_light`, `boss2_move_pain_light`, avec sons, skin, `pain_debounce_time`, nightmare-skip et retour `boss2_run`. | Haute |
