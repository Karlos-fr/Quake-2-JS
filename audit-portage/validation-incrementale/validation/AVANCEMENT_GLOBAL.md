...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 43 | 0 | 0 | 0 | 38 | `CL_RocketTrail` seul, avec ses locaux `move`, `vec`, `len`, `j` et `dec`; garder `CL_RailTrail` pour une session separee si le lot grossit. | Normale |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 13 | 2 | 0 | 0 | 14 | `G_FreeEdict` seul, sans traiter les lignes locales `i`/`e` ni les helpers `vectoyaw`/`vectoangles`; `vectoyaw` reste partiel tant que `p_trail.ts` garde son doublon prive; `vectoangles` reste partiel tant que `g_weapon.ts` garde son helper local; clarifier separement la ligne globale `v` pointee vers `g_weapon.ts`. | Haute |
...
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 30 | 0 | 0 | 0 | 0 | Valider le bloc flipoff: `actor_frames_flipoff` (lignes global/table/declarative) et `actor_move_flipoff`, en gardant `actor_pain` pour un lot separe si le lot devient trop large. | Haute |
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) |  | A demarrer | 482 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 9 | 0 | 0 | 0 | 1 | Valider le bloc stand: `berserk_frames_stand` global/table/declarative, `berserk_move_stand` et `berserk_stand`; garder `berserk_frames_stand_fidget` / `berserk_move_stand_fidget` pour une session separee si le lot devient trop large. | Haute |
| `Quake-2-master/game/m_berserk.h` | [`game_m_berserk.h.md`](matrices/game_m_berserk.h.md) |  | A demarrer | 245 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss2.c` | [`game_m_boss2.c.md`](matrices/game_m_boss2.c.md) | [`game_m_boss2.c.md`](progress/game_m_boss2.c.md) | En cours | 78 | 5 | 0 | 0 | 0 | 0 | `boss2_search` seul, avec la branche `random() < 0.5`, l'emission `sound_search1`, et le branchement `monsterinfo.search`; garder les fonctions d'attaque, frames et moves pour des sessions separees. | Haute |
