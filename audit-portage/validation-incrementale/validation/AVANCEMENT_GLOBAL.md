...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 19 | 0 | 0 | 0 | 7 | `CL_ParseMuzzleFlash` avec ses temporaires `silenced`, `volume`, `soundname` si le lot reste raisonnable; sinon limiter au branchement dlight/sound du premier sous-ensemble de muzzle flashes. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 225 | 0 | 0 | 0 | 1 | Continuer avec `sm_meat_index` et `snd_fry`, puis `jacket_armor_index` et `combat_armor_index` si le lot reste petit, avec preuves d'initialisation precache/items et consommation runtime. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 33 | 0 | 0 | 0 | 0 | Continuer avec `WriteLevelLocals`, puis ses temporaires locaux `field` et `temp` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 29 | 8 | 0 | 0 | 0 | 0 | Continuer avec `ED_CallSpawn`, en limitant le lot au chemin itemlist/table/warning et au branchement depuis `SpawnEntities`. | Haute |
...
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 32 | 0 | 0 | 0 | 0 | `target_crosslevel_target_think` et `SP_target_crosslevel_target`. | Haute |
...
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 3 | 0 | 0 | 0 | 20 | `fire_bullet` et `fire_shotgun`; valider leurs wrappers vers `fire_lead`, leurs commentaires, les chemins `p_weapon`/monstres et les tests existants. | Haute |
