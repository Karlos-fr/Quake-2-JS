...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par famille `m_*` non reservee des consommateurs runtime de `random`/`crandom`; `m_insane.ts` et `m_mutant.ts` viennent d'etre migres/verifies, prochain lot recommande `m_soldier.ts`, puis `m_tank.ts`/`m_supertank.ts` ou `g_utils.ts` quand non reserve. | Haute |
...
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) | [`game_m_actor.h.md`](progress/game_m_actor.h.md) | En cours | 482 | 283 | 0 | 0 | 0 | 0 | `FRAME_bl_atk01` a `FRAME_bl_std13`. | Haute |
...
| `Quake-2-master/game/m_boss31.c` | [`game_m_boss31.c.md`](matrices/game_m_boss31.c.md) | [`game_m_boss31.c.md`](progress/game_m_boss31.c.md) | En cours | 103 | 55 | 0 | 0 | 0 | 5 | `jorg_frames_death1` global/table/declarative, `jorg_move_death`, `jorg_dead`; inclure `jorg_die` si le lot reste coherent. | Haute |
| `Quake-2-master/game/m_boss31.h` | [`game_m_boss31.h.md`](matrices/game_m_boss31.h.md) |  | A demarrer | 189 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss32.c` | [`game_m_boss32.c.md`](matrices/game_m_boss32.c.md) | [`game_m_boss32.c.md`](progress/game_m_boss32.c.md) | En cours | 110 | 50 | 0 | 0 | 0 | 8 | `makron_frames_death2`, `makron_move_death2`, `makron_frames_death3`, `makron_move_death3`, `makron_frames_sight`, `makron_move_sight`, puis `makron_sight` si coherent. | Haute |
