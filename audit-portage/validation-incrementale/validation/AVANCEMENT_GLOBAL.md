...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 29 | 0 | 0 | 0 | 7 | `cl_numparticles`, `CL_ClearParticles` et le temporaire local `i` si le lot reste coherent. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 238 | 0 | 0 | 0 | 1 | Continuer avec les macros MOD a partir de `MOD_ROCKET` si le lot reste petit, avec preuves weapon/combat/death messages et sorties visibles associees. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 42 | 0 | 0 | 0 | 0 | Continuer avec `ReadLevel`, puis ses temporaires locaux `entnum`, `i` et `ent` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 29 | 14 | 0 | 0 | 0 | 8 | Continuer avec les temporaires locaux de `SpawnEntities` (`ent`, `inhibit`, `com_token`, `i`, `skill_level`) si le lot reste coherent. | Haute |
...
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 46 | 0 | 0 | 0 | 1 | `target_lightramp_think` avec les locaux `style` et `temp` si le lot reste raisonnable; garder `target_lightramp_use` et `SP_target_lightramp` pour un lot suivant si besoin. | Haute |
...
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 8 | 0 | 0 | 0 | 30 | `Grenade_Touch`, puis `fire_grenade` et son temporaire local `grenade` si le lot reste petit. | Haute |
...
| `Quake-2-master/qcommon/common.c` | [`qcommon_common.c.md`](matrices/qcommon_common.c.md) | [`qcommon_common.c.md`](progress/qcommon_common.c.md) | En cours | 150 | 1 | 0 | 0 | 0 | 0 | Reprendre la matrice autour de `MSG_WriteDeltaEntity()` sous consigne separee; ne pas elargir automatiquement aux temporaires locaux si la regle super admin reste active. | Haute |
