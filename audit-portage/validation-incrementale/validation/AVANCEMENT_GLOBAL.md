...
| `Quake-2-master/game/g_ai.c` | [`game_g_ai.c.md`](matrices/game_g_ai.c.md) | [`game_g_ai.c.md`](progress/game_g_ai.c.md) | En cours | 48 | 26 | 0 | 0 | 0 | 21 | locale restante `v` de `ai_run` | Haute |
...
| `Quake-2-master/game/g_cmds.c` | [`game_g_cmds.c.md`](matrices/game_g_cmds.c.md) | [`game_g_cmds.c.md`](progress/game_g_cmds.c.md) | En cours | 74 | 52 | 0 | 0 | 0 | 0 | `PlayerSort`, puis `Cmd_Players_f` et temporaires si le lot reste raisonnable | Haute |
...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 51 | 0 | 0 | 0 | 0 | `button_fire` | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 19 | 0 | 0 | 0 | 0 | `ArmorIndex`, `Pickup_Armor` et locales associees | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 46 | 0 | 0 | 0 | 1 | `AI_STAND_GROUND`, `AI_TEMP_STAND_GROUND`, `AI_SOUND_TARGET` | Haute |
| `Quake-2-master/game/g_main.c` | [`game_g_main.c.md`](matrices/game_g_main.c.md) | [`game_g_main.c.md`](progress/game_g_main.c.md) | En cours | 75 | 15 | 7 | 0 | 0 | 0 | `gun_x`, `gun_y`, `gun_z`, `run_pitch`, `run_roll`, `bob_up`, `bob_pitch`, `bob_roll` | Haute |
