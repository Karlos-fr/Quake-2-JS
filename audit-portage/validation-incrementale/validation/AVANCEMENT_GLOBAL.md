...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer les consommateurs restants de `random`/`crandom`: `g_utils.ts` verifie hors macros, `m_brain.ts`, `m_float.ts`, `m_flyer.ts`, `m_gladiator.ts`, `m_medic.ts`, `m_parasite.ts` verifies, `m_flipper.ts` confirme hors macros; prochain lot recommande `m_actor.ts`, `m_boss2.ts` ou `m_boss32.ts` si non reserves. | Haute |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | Partiel | 37 | 18 | 1 | 0 | 0 | 18 | Reprendre le blocage separe `vectoangles` -> `g_weapon.ts`; ne plus rouvrir `vectoyaw` sauf regression. | Haute |
...
| `Quake-2-master/game/m_boss32.c` | [`game_m_boss32.c.md`](matrices/game_m_boss32.c.md) | [`game_m_boss32.c.md`](progress/game_m_boss32.c.md) | En cours | 110 | 84 | 0 | 0 | 0 | 14 | `Makron_CheckAttack`, avec `chance`/`tr`/`enemy_infront`/`enemy_range`/`enemy_yaw` si coherent. | Haute |
| `Quake-2-master/game/m_boss32.h` | [`game_m_boss32.h.md`](matrices/game_m_boss32.h.md) |  | A demarrer | 492 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_brain.c` | [`game_m_brain.c.md`](matrices/game_m_brain.c.md) | [`game_m_brain.c.md`](progress/game_m_brain.c.md) | En cours | 92 | 36 | 0 | 0 | 0 | 2 | Continuer avec le bloc defense/pain/duck: `brain_frames_defense`, les mouvements pain, puis `brain_duck_*`/`brain_dodge` si le lot reste coherent. | Haute |
...
| `Quake-2-master/game/m_chick.h` | [`game_m_chick.h.md`](matrices/game_m_chick.h.md) | [`game_m_chick.h.md`](progress/game_m_chick.h.md) | En cours | 289 | 83 | 0 | 0 | 0 | 0 | Continuer avec `FRAME_duck01` a `FRAME_pain321`, puis les mouvements `chick_move_duck` et `chick_move_pain*` cote runtime visible. | Haute |
