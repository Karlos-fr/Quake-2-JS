...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 621 | 203 | 0 | 0 | 0 | 1 | Continuer avec `mframe_t`, `dist` et les callbacks `aifunc`/`thinkfunc` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 103 | 0 | 0 | 0 | 0 | `SP_target_string`, `CLOCK_MESSAGE_SIZE`, `func_clock_reset` et `func_clock_format_countdown` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 9 | 0 | 0 | 0 | 0 | Temporaires locaux de `WriteField1`: `p`, `len`, `index`. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 135 | 10 | 0 | 0 | 0 | 0 | `SP_func_plat`, `SP_func_rotating`, `SP_func_button` et `SP_func_door` si le lot reste raisonnable. | Haute |
| `Quake-2-master/game/g_svcmds.c` | [`game_g_svcmds.c.md`](matrices/game_g_svcmds.c.md) | [`game_g_svcmds.c.md`](progress/game_g_svcmds.c.md) | En cours | 29 | 6 | 0 | 0 | 0 | 0 | `StringToFilter` et ses locaux `num`, `b`, `m` si le lot reste centre sur le parsing d'adresse. | Haute |
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 59 | 6 | 0 | 0 | 0 | 0 | `buffer`, `strncpy`, `Use_Target_Help`, le second `strncpy`, puis `SP_target_help` si le lot reste petit. | Haute |
