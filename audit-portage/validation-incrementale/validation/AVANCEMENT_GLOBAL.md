...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 131 | 0 | 0 | 0 | 1 | `door_secret_die`, puis `SP_func_door_secret` et ses locales matricielles (`side`, `width`, `length`) si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 106 | 0 | 0 | 0 | 0 | locale `index` de `Pickup_PowerArmor`, puis `quantity` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 176 | 0 | 0 | 0 | 1 | `item`, puis `gravity`, `minyaw`, `maxyaw`, `minpitch`, `maxpitch` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 87 | 0 | 0 | 0 | 0 | Lignes externes restantes `train_use` et `func_train_find`, puis `misc_strogg_ship_use` / `SP_misc_strogg_ship` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 40 | 0 | 0 | 0 | 0 | `walkmonster_start`, puis `flymonster_start_go` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | En cours | 64 | 63 | 0 | 0 | 0 | 0 | `G_RunEntity`. | Haute |
