...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 32 | 0 | 0 | 0 | 9 | `CL_ParticleEffect2` avec son temporaire local `d`. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 265 | 0 | 0 | 0 | 1 | `meansOfDeath`, puis `g_edicts` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_turret.c` | [`game_g_turret.c.md`](matrices/game_g_turret.c.md) | [`game_g_turret.c.md`](progress/game_g_turret.c.md) | En cours | 23 | 3 | 0 | 0 | 0 | 1 | `turret_breach_fire` avec les locaux `damage` et `speed`. | Haute |
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 1 | 0 | 0 | 0 | 0 | `G_Find`, puis le local C `s` associe si le lot reste petit. | Haute |
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 13 | 0 | 0 | 0 | 35 | `fire_rail` avec `from`, `end`, `tr`, premier `ignore`, `mask`, `water` si le lot reste coherent. | Haute |
