...
| `Quake-2-master/game/g_ai.c` | [`game_g_ai.c.md`](matrices/game_g_ai.c.md) | [`game_g_ai.c.md`](progress/game_g_ai.c.md) | En cours | 48 | 25 | 0 | 0 | 0 | 16 | `ai_run` en sous-lots: `AI_SOUND_TARGET`, `AS_SLIDING`, retour `ai_checkattack` | Haute |
...
| `Quake-2-master/game/g_cmds.c` | [`game_g_cmds.c.md`](matrices/game_g_cmds.c.md) | [`game_g_cmds.c.md`](progress/game_g_cmds.c.md) | En cours | 74 | 48 | 0 | 0 | 0 | 0 | `Cmd_InvDrop_f` avec temporaire `it` | Haute |
...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 48 | 0 | 0 | 0 | 0 | `button_done` | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 12 | 0 | 0 | 0 | 0 | `Weapon_Railgun` | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 36 | 0 | 0 | 0 | 1 | `DEAD_NO`, `DEAD_DYING`, `DEAD_DEAD`, `DEAD_RESPAWNABLE` | Haute |
