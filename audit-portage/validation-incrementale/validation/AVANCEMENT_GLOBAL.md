...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par famille `m_*` non reservee des consommateurs runtime de `random`/`crandom`; `m_chick.ts` vient d'etre migre/verifie, prochain lot recommande `m_infantry.ts` ou `m_hover.ts`. | Haute |
...
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) | [`game_m_actor.h.md`](progress/game_m_actor.h.md) | En cours | 482 | 39 | 0 | 0 | 0 | 0 | `FRAME_flip01` a `FRAME_grenad15`. | Haute |
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 45 | 0 | 0 | 0 | 1 | Valider le bloc douleur `berserk_frames_pain1`, `berserk_move_pain1`, `berserk_frames_pain2`, `berserk_move_pain2` et `berserk_pain`, avec son pain, skin, `pain_debounce_time`, nightmare-skip, selection par degats/random et retour `berserk_run`. | Haute |
| `Quake-2-master/game/m_berserk.h` | [`game_m_berserk.h.md`](matrices/game_m_berserk.h.md) |  | A demarrer | 245 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss2.c` | [`game_m_boss2.c.md`](matrices/game_m_boss2.c.md) | [`game_m_boss2.c.md`](progress/game_m_boss2.c.md) | En cours | 78 | 55 | 0 | 0 | 0 | 1 | Valider le bloc machinegun restant `boss2_firebullet_right`, `boss2_firebullet_left` et `Boss2MachineGun`, avec visee `VectorMA`, offsets gauche/droite, degats/spread, muzzleflash, sons/impacts runtime et consommation web/renderer. | Haute |
...
| `Quake-2-master/game/m_boss31.c` | [`game_m_boss31.c.md`](matrices/game_m_boss31.c.md) | [`game_m_boss31.c.md`](progress/game_m_boss31.c.md) | En cours | 103 | 19 | 0 | 0 | 0 | 5 | `jorg_frames_stand`, `jorg_move_stand`, `jorg_stand`, puis si le lot reste raisonnable `jorg_frames_run`, `jorg_move_run` et `jorg_run`. | Haute |
