...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 624 | 214 | 0 | 0 | 0 | 1 | Continuer avec `monsterinfo_t.aiflags`, `nextframe` et `scale` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 115 | 0 | 0 | 0 | 0 | `SP_misc_teleporter` avec local `trig`, puis `SP_misc_teleporter_dest` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 15 | 0 | 0 | 0 | 0 | Continuer avec `ReadField`, puis ses temporaires locaux `p`, `len`, `index` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 135 | 21 | 0 | 0 | 0 | 0 | `SP_func_explosive`, puis `SP_func_areaportal` si le lot reste coherent avec `g_misc.ts`. | Haute |
| `Quake-2-master/game/g_svcmds.c` | [`game_g_svcmds.c.md`](matrices/game_g_svcmds.c.md) | [`game_g_svcmds.c.md`](progress/game_g_svcmds.c.md) | En cours | 29 | 17 | 0 | 0 | 0 | 0 | `SVCmd_RemoveIP_f`, avec recherche du filtre, compactage du tableau, et messages `Removed.` / `Didn't find`. | Haute |
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 59 | 15 | 0 | 0 | 0 | 0 | `target_explosion_explode`, le local `save`, `use_target_explosion` et `SP_target_explosion` si le lot reste petit. | Haute |
