...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 106 | 0 | 0 | 0 | 1 | `func_timer_think`, `func_timer_use`, puis `SP_func_timer` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 91 | 0 | 0 | 0 | 0 | `Use_Invulnerability`. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 144 | 0 | 0 | 0 | 1 | `level_locals_t.intermissiontime`, `changemap`, `exitintermission` si le lot reste raisonnable. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 65 | 0 | 0 | 0 | 0 | `misc_easterchick2_think` et `SP_misc_easterchick2`. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 27 | 0 | 0 | 0 | 0 | `monster_use`. | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | En cours | 64 | 30 | 0 | 0 | 0 | 0 | `pushed_t`, puis locales `ent`, `deltayaw` et `obstacle` si le lot reste petit. | Haute |
