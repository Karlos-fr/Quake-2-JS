...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 219 | 0 | 0 | 0 | 1 | Continuer avec `monsterinfo_t.attack_state`, `lefty` et `idle_time` si le lot reste petit, en s'appuyant sur les preuves AI attack/sliding/idle-search et save/load. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 23 | 0 | 0 | 0 | 0 | Continuer avec `WriteGame`, puis ses temporaires locaux `i` et `str` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 31 | 3 | 0 | 0 | 0 | 0 | Valider `SP_light` dans un lot separe rattache a `packages/game/src/g_misc.ts`. | Haute |
| `Quake-2-master/game/g_svcmds.c` | [`game_g_svcmds.c.md`](matrices/game_g_svcmds.c.md) | [`game_g_svcmds.c.md`](progress/game_g_svcmds.c.md) | En cours | 29 | 27 | 0 | 0 | 0 | 0 | Continuer avec `ServerCommand`, puis son local `cmd`. | Haute |
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 23 | 0 | 0 | 0 | 0 | `use_target_spawner`, le local `ent` associe et `SP_target_spawner` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_trigger.c` | [`game_g_trigger.c.md`](matrices/game_g_trigger.c.md) | [`game_g_trigger.c.md`](progress/game_g_trigger.c.md) | En cours | 33 | 12 | 0 | 0 | 0 | 5 | Continuer avec `trigger_counter_use` et `SP_trigger_counter`, puis `SP_trigger_always` si le lot reste petit. | Haute |
