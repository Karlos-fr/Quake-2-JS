...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 623 | 304 | 0 | 0 | 0 | 1 | Continuer avec `world`, puis `ITEM_TRIGGER_SPAWN`, `ITEM_NO_TOUCH`, `DROPPED_ITEM`, `DROPPED_PLAYER_ITEM`, `ITEM_TARGETS_USED`, `FFL_SPAWNTEMP`, `FFL_NOSPAWN`. | Haute |
