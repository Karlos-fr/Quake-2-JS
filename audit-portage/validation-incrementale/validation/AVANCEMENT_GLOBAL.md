...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 216 | 0 | 0 | 0 | 1 | Continuer avec `monsterinfo_t.search_time`, `trail_time` et `last_sighting` si le lot reste petit, en s'appuyant sur les preuves AI/monster et save/load. | Haute |
...
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 30 | 2 | 0 | 0 | 0 | 0 | Valider `SP_func_clock` dans un lot separe rattache a `packages/game/src/g_misc.ts`. | Haute |
| `Quake-2-master/game/g_svcmds.c` | [`game_g_svcmds.c.md`](matrices/game_g_svcmds.c.md) | [`game_g_svcmds.c.md`](progress/game_g_svcmds.c.md) | En cours | 29 | 21 | 0 | 0 | 0 | 0 | Continuer avec `SVCmd_WriteIP_f`, puis ses locaux `name`, `b`, `i`, `game` et l'adaptation `sprintf` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 21 | 0 | 0 | 0 | 0 | `use_target_splash` et `SP_target_splash` si le lot reste petit. | Haute |
