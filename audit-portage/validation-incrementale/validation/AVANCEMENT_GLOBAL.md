...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 129 | 0 | 0 | 0 | 1 | `door_secret_use`, puis `door_secret_blocked` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 104 | 0 | 0 | 0 | 0 | `MegaHealth_think`, puis `Pickup_Health` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 170 | 0 | 0 | 0 | 1 | `nextmap`, puis `lip`, `distance`, `height`, `noise`, `pausetime` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 83 | 0 | 0 | 0 | 0 | `diff`, `misc_viper_bomb_use`, `viper` et `SP_misc_viper_bomb` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 35 | 0 | 0 | 0 | 0 | locales `notcombat`, `fixup`, `target` de `monster_start_go`, puis `walkmonster_start_go` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | En cours | 64 | 54 | 0 | 0 | 0 | 0 | `SV_Physics_Step` avec locales `wasonground`, `hitsound`, `vel`, `friction`, `groundentity` et `mask` si le lot reste raisonnable. | Haute |
