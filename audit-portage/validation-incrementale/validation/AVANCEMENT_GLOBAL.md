...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 54 | 0 | 0 | 0 | 82 | `CL_TeleportParticles` avec ses locaux `vel` et `dir`, puis `CL_AddParticles` avec `alpha`, `org` et `color` si le lot reste coherent. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par famille `m_*` non reservee des consommateurs runtime de `random`/`crandom`; `m_gladiator.ts` vient d'etre migre/verifie, prochain lot recommande `m_chick.ts` ou `m_gunner.ts`. | Haute |
...
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 61 | 0 | 0 | 0 | 0 | Valider le bloc scripted actor restant `actor_use` avec le local `v`, puis `target_actor_touch` avec les locaux `n`, `ent`, `savetarget`, et `SP_target_actor`; inclure `SP_misc_actor` si le lot reste coherent avec le spawn/ownership restant. | Haute |
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) |  | A demarrer | 482 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 34 | 0 | 0 | 0 | 1 | Valider le bloc adjacent `berserk_attack_club`, `berserk_frames_attack_club` global/table/declarative et `berserk_move_attack_club`, avec `aim[1] = self->mins[0]`, `fire_hit`, `berserk_swing`, `endfunc = berserk_run`, selection depuis `berserk_melee` et sorties visibles/audibles. | Haute |
| `Quake-2-master/game/m_berserk.h` | [`game_m_berserk.h.md`](matrices/game_m_berserk.h.md) |  | A demarrer | 245 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss2.c` | [`game_m_boss2.c.md`](matrices/game_m_boss2.c.md) | [`game_m_boss2.c.md`](progress/game_m_boss2.c.md) | En cours | 78 | 41 | 0 | 0 | 0 | 1 | Valider le bloc roquettes separe: `Boss2Rocket`, `boss2_frames_attack_rocket`, `boss2_move_attack_rocket`, et seulement ensuite les helpers de tir rocket si le lot reste borne. | Haute |
