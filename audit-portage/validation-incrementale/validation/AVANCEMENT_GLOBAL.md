...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 623 | 362 | 0 | 0 | 0 | 119 | Continuer avec `client_respawn_t`, puis champs `enterframe`, `score`, `cmd_angles`, `spectator`, en gardant `gclient_s` pour une session separee si le lot devient trop large. | Haute |
...
| `Quake-2-master/game/m_insane.c` | [`game_m_insane.c.md`](matrices/game_m_insane.c.md) | [`game_m_insane.c.md`](progress/game_m_insane.c.md) | En cours | 92 | 46 | 0 | 0 | 0 | 8 | Continuer avec `insane_frames_stand_death`, `insane_move_stand_death`, `insane_frames_crawl`, `insane_move_crawl`, `insane_move_runcrawl`, `insane_frames_crawl_pain`, `insane_move_crawl_pain`, puis `insane_frames_crawl_death`/`insane_move_crawl_death` si le lot reste coherent. | Haute |
| `Quake-2-master/game/m_insane.h` | [`game_m_insane.h.md`](matrices/game_m_insane.h.md) |  | A demarrer | 283 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_medic.c` | [`game_m_medic.c.md`](matrices/game_m_medic.c.md) | [`game_m_medic.c.md`](progress/game_m_medic.c.md) | En cours | 83 | 39 | 0 | 0 | 0 | 7 | Reprendre `medic_dead`, `medic_frames_death`, `medic_move_death`, `medic_die`, variable locale `n`, puis `medic_duck_down`/`medic_duck_hold`/`medic_duck_up` si le lot reste coherent. | Haute |
...
| `Quake-2-master/game/m_mutant.c` | [`game_m_mutant.c.md`](matrices/game_m_mutant.c.md) | [`game_m_mutant.c.md`](progress/game_m_mutant.c.md) | En cours | 92 | 38 | 0 | 0 | 0 | 2 | Continuer avec le bloc melee/attack: `mutant_hit_left`, `mutant_hit_right`, `mutant_check_refire`, `mutant_frames_attack`, `mutant_move_attack`, `mutant_melee`, puis seulement inclure le debut du jump si le lot reste coherent. | Haute |
| `Quake-2-master/game/m_mutant.h` | [`game_m_mutant.h.md`](matrices/game_m_mutant.h.md) |  | A demarrer | 150 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_parasite.c` | [`game_m_parasite.c.md`](matrices/game_m_parasite.c.md) | [`game_m_parasite.c.md`](progress/game_m_parasite.c.md) | En cours | 100 | 74 | 0 | 0 | 0 | 0 | Reprendre avec `parasite_frames_pain1`, `parasite_move_pain1`, `parasite_pain`, puis `parasite_drain_attack_ok`, `parasite_drain_attack`, `tr` et `damage` si le lot reste coherent. | Haute |
