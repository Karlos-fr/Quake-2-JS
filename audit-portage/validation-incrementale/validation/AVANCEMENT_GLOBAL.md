...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par famille `m_*` non reservee des consommateurs runtime de `random`/`crandom`; `m_hover.ts` vient d'etre migre/verifie, prochain lot recommande `m_infantry.ts`, puis `g_utils.ts` quand non reserve. | Haute |
...
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) | [`game_m_actor.h.md`](progress/game_m_actor.h.md) | En cours | 482 | 116 | 0 | 0 | 0 | 0 | `FRAME_salute01` a `FRAME_stand240`. | Haute |
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 54 | 0 | 0 | 0 | 1 | Valider `berserk_dead`, `berserk_frames_death1`, `berserk_move_death1`, `berserk_frames_death2`, `berserk_move_death2`, `berserk_die`. | Haute |
| `Quake-2-master/game/m_berserk.h` | [`game_m_berserk.h.md`](matrices/game_m_berserk.h.md) |  | A demarrer | 245 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss2.c` | [`game_m_boss2.c.md`](matrices/game_m_boss2.c.md) | [`game_m_boss2.c.md`](progress/game_m_boss2.c.md) | En cours | 78 | 58 | 0 | 0 | 0 | 1 | Valider `Boss2_CheckAttack` avec `chance`, `tr`, `enemy_infront`, `enemy_range`, `enemy_yaw`. | Haute |
...
| `Quake-2-master/game/m_boss31.c` | [`game_m_boss31.c.md`](matrices/game_m_boss31.c.md) | [`game_m_boss31.c.md`](progress/game_m_boss31.c.md) | En cours | 103 | 29 | 0 | 0 | 0 | 5 | `jorg_frames_start_walk`, `jorg_move_start_walk`, `jorg_frames_walk`, `jorg_move_walk`, `jorg_frames_end_walk`, `jorg_move_end_walk`, `jorg_walk`. | Haute |
| `Quake-2-master/game/m_boss31.h` | [`game_m_boss31.h.md`](matrices/game_m_boss31.h.md) |  | A demarrer | 189 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss32.c` | [`game_m_boss32.c.md`](matrices/game_m_boss32.c.md) | [`game_m_boss32.c.md`](progress/game_m_boss32.c.md) | En cours | 110 | 28 | 0 | 0 | 0 | 8 | `makron_hit`, `makron_popup`, `makron_brainsplorch`, `makron_prerailgun`, puis bloc walk. | Haute |
