...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 4 | 0 | 0 | 0 | 0 | `clightstyle_t`, `CL_ClearLightStyles`, `CL_RunLightStyles`, `CL_SetLightstyle`, `CL_AddLightStyles` si le lot reste raisonnable. | Normale |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 27 | 0 | 0 | 0 | 0 | Continuer avec `ReadGame`, puis ses temporaires locaux `i` et `str` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 31 | 3 | 0 | 0 | 0 | 0 | Continuer avec `SP_worldspawn` ou un sous-lot explicite de `spawns`; ne pas valider ici les fonctions externes deja proprietaires de `g_misc.c`, `g_func.c`, `p_client.c` ou `g_items.c`. | Haute |
...
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 26 | 0 | 0 | 0 | 0 | `use_target_blaster`, les locaux `effect` associes et `SP_target_blaster` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_trigger.c` | [`game_g_trigger.c.md`](matrices/game_g_trigger.c.md) | [`game_g_trigger.c.md`](progress/game_g_trigger.c.md) | En cours | 33 | 15 | 0 | 0 | 0 | 5 | Continuer avec `PUSH_ONCE`, `windsound`, `trigger_push_touch` et `SP_trigger_push` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 1 | 0 | 0 | 0 | 2 | `fire_hit` et ses temporaires locaux (`tr`, `v`, `point`, `range`, `dir`, `aim`) si le lot reste petit. | Haute |
