...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 624 | 212 | 0 | 0 | 0 | 1 | Continuer avec `monsterinfo_t` et `currentmove` en s'appuyant sur les preuves `mmove_t` deja ajoutees. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 112 | 0 | 0 | 0 | 0 | `SP_func_clock`, puis `teleporter_touch` avec local `dest` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 13 | 0 | 0 | 0 | 0 | Continuer avec les temporaires locaux auto-detectes de `WriteField2`: `len` puis `p`, rattaches a l'adaptateur JSON structure. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 135 | 18 | 0 | 0 | 0 | 0 | `SP_func_conveyor`, puis `SP_func_wall` / `SP_func_object` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_svcmds.c` | [`game_g_svcmds.c.md`](matrices/game_g_svcmds.c.md) | [`game_g_svcmds.c.md`](progress/game_g_svcmds.c.md) | En cours | 29 | 15 | 0 | 0 | 0 | 0 | `SVCmd_AddIP_f` et son local `i` si le lot reste centre sur l'ajout d'un filtre et la recherche de slot libre. | Haute |
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 59 | 13 | 0 | 0 | 0 | 0 | `use_target_goal` et `SP_target_goal` si le lot reste petit. | Haute |
