...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 623 | 332 | 0 | 0 | 0 | 57 | Continuer les declarations non proprietaires immediatement apres, bloc `g_misc.c` de `ThrowHead` a `ClockExplosion`, puis reprendre les prochains macros/globals proprietaires qui suivent. | Haute |
...
| `Quake-2-master/game/m_flyer.h` | [`game_m_flyer.h.md`](matrices/game_m_flyer.h.md) | [`game_m_flyer.h.md`](progress/game_m_flyer.h.md) | En cours | 157 | 63 | 0 | 0 | 0 | 0 | `FRAME_attak101..FRAME_attak217`, avec les moves melee/attack associes si le lot reste coherent. | Haute |
...
| `Quake-2-master/game/m_gladiator.h` | [`game_m_gladiator.h.md`](matrices/game_m_gladiator.h.md) | [`game_m_gladiator.h.md`](progress/game_m_gladiator.h.md) | En cours | 91 | 46 | 0 | 0 | 0 | 0 | Valider `FRAME_attack1` a `FRAME_attack9`, puis `FRAME_pain1` a `FRAME_pain6` si le lot reste coherent. | Haute |
...
| `Quake-2-master/game/m_gunner.h` | [`game_m_gunner.h.md`](matrices/game_m_gunner.h.md) | [`game_m_gunner.h.md`](progress/game_m_gunner.h.md) | En cours | 210 | 108 | 0 | 0 | 0 | 0 | `FRAME_attak101` a `FRAME_attak121`, puis `FRAME_attak201` a `FRAME_attak230` si coherent. | Haute |
| `Quake-2-master/game/m_hover.c` | [`game_m_hover.c.md`](matrices/game_m_hover.c.md) | [`game_m_hover.c.md`](progress/game_m_hover.c.md) | En cours | 95 | 13 | 0 | 0 | 0 | 7 | Valider le bloc attaque complet `hover_reattack`, `hover_fire_blaster`, `hover_move_start_attack`, `hover_move_attack1`, `hover_move_end_attack` et les entrees `effect` associees. | Haute |
| `Quake-2-master/game/m_hover.h` | [`game_m_hover.h.md`](matrices/game_m_hover.h.md) |  | A demarrer | 206 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_infantry.c` | [`game_m_infantry.c.md`](matrices/game_m_infantry.c.md) | [`game_m_infantry.c.md`](progress/game_m_infantry.c.md) | En cours | 84 | 31 | 0 | 0 | 0 | 0 | `infantry_frames_pain1`, `infantry_move_pain1`, `infantry_frames_pain2`, `infantry_move_pain2`, `infantry_pain`, puis verifier `aimangles`/`InfantryMachineGun` si le lot reste coherent. | Haute |
