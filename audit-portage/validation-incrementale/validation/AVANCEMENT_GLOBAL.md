...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 137 | 0 | 0 | 0 | 1 | `VectorMA`, puis `use_killbox` / `SP_func_killbox` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 108 | 0 | 0 | 0 | 0 | locale `dropped` de `Drop_Item`. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 182 | 0 | 0 | 0 | 1 | debut de `moveinfo_t`: structure, puis `start_origin`, `start_angles`, `end_origin`, `end_angles` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 91 | 0 | 0 | 0 | 0 | `misc_satellite_dish_think`, `misc_satellite_dish_use` et `SP_misc_satellite_dish` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 42 | 0 | 0 | 0 | 0 | `flymonster_start`, puis `swimmonster_start_go` si le lot reste petit. | Haute |
