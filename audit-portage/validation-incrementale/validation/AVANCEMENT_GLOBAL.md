...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 98 | 0 | 0 | 0 | 1 | Continuer avec `func_train_find` et sa locale `ent`, puis `train_use` avec l'appel `train_next` doublon si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 86 | 0 | 0 | 0 | 0 | Reprendre la prochaine entree `A verifier` restante de `game_g_items.c.md` dans l'ordre de la matrice: `Pickup_Pack`, avec les locales `item` et `index` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 138 | 0 | 0 | 0 | 1 | Continuer avec `level_locals_t`, petit lot initial: structure `level_locals_t` puis champs `framenum` et `time` si le lot reste raisonnable. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 58 | 0 | 0 | 0 | 0 | `misc_blackhole_use`, `misc_blackhole_think`, puis `SP_misc_blackhole` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 23 | 0 | 0 | 0 | 0 | `M_MoveFrame` avec `move` et `index` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | En cours | 64 | 25 | 0 | 0 | 0 | 0 | `SV_AddGravity`. | Haute |
