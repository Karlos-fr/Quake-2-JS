...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 101 | 0 | 0 | 0 | 1 | `SP_func_train`, puis `trigger_elevator_use` avec la locale `target` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 89 | 0 | 0 | 0 | 0 | `Use_Breather`, avec la locale `timeout` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 141 | 0 | 0 | 0 | 1 | `level_locals_t.level_name`, `mapname`, `nextmap` si le lot reste raisonnable. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 61 | 0 | 0 | 0 | 0 | `misc_eastertank_think` et `SP_misc_eastertank`. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 26 | 0 | 0 | 0 | 0 | `monster_think`. | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | En cours | 64 | 26 | 0 | 0 | 0 | 0 | `SV_PushEntity` avec locales `trace` et `mask`, incluant l'entree `mask` dupliquee si le lot reste petit. | Haute |
