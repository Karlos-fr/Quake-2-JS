...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 24 | 0 | 0 | 0 | 7 | `CL_ParseMuzzleFlash2` avec `ent`, `origin`, `flash_number` et `soundname`, en limitant au premier sous-ensemble monster muzzle flashes si le lot devient trop large. | Normale |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 36 | 0 | 0 | 0 | 0 | Continuer avec `ReadEdict`, puis son temporaire local `field` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 29 | 10 | 0 | 0 | 0 | 2 | Continuer avec `ED_NewString`, puis `ED_ParseField` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 34 | 0 | 0 | 0 | 0 | `target_laser_think` avec les locaux `ignore`, `tr` et `count` associes si le lot reste raisonnable; sinon limiter au premier sous-ensemble du trace/damage laser. | Haute |
| `Quake-2-master/game/g_trigger.c` | [`game_g_trigger.c.md`](matrices/game_g_trigger.c.md) | [`game_g_trigger.c.md`](progress/game_g_trigger.c.md) | En cours | 33 | 22 | 0 | 0 | 0 | 7 | Continuer avec `trigger_gravity_touch` et `SP_trigger_gravity`. | Haute |
...
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 5 | 0 | 0 | 0 | 21 | `blaster_touch` et ses temporaires locaux `mod` si le lot reste coherent. | Haute |
