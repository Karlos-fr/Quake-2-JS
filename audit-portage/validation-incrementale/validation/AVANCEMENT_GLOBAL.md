...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 47 | 0 | 0 | 0 | 59 | `BEAMLENGTH` puis `CL_FlyParticles` en lot borne; verifier aussi les locaux `i`, `angle`, `forward`, `dist`, `ltime` si rattaches. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par petite famille `m_*` non reservee des consommateurs runtime de `random`/`crandom`; `m_medic.ts` vient d'etre migre/verifie, prochain lot recommande `m_float.ts` ou autre famille `m_*` non reservee. | Haute |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 17 | 2 | 0 | 0 | 15 | Clarifier les lignes locales restantes `v`, `i` et `e`, en commencant par `v` pointee vers `g_weapon.ts` si ce fichier n'est pas reserve; ne pas rouvrir `vectoyaw`/`vectoangles` hors blocage documente. | Haute |
