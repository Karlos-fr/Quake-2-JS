...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 38 | 0 | 0 | 0 | 0 | Continuer avec `ReadLevelLocals`, puis son temporaire local `field` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 29 | 12 | 0 | 0 | 0 | 5 | Continuer avec `ED_ParseEdict` et ses temporaires locaux `init`, `keyname` et `com_token`, en limitant le lot au parse braces/key-value et au warning `angle` -> `angles`. | Haute |
...
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 39 | 0 | 0 | 0 | 0 | `target_laser_on`, `target_laser_off` et `target_laser_use`; inclure la ligne dupliquee `target_laser_on` seulement si le lot reste petit. | Haute |
| `Quake-2-master/game/g_trigger.c` | [`game_g_trigger.c.md`](matrices/game_g_trigger.c.md) | [`game_g_trigger.c.md`](progress/game_g_trigger.c.md) | En cours | 33 | 24 | 0 | 0 | 0 | 7 | Continuer avec `trigger_monsterjump_touch` et `SP_trigger_monsterjump`. | Haute |
...
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 6 | 0 | 0 | 0 | 23 | `fire_blaster` avec `bolt` et `tr` si le lot reste coherent. | Haute |
