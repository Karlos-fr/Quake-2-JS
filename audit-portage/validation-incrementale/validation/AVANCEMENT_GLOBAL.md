...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 125 | 0 | 0 | 0 | 1 | `door_secret_move6` et `door_secret_done`, puis leurs doublons matriciels si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 102 | 0 | 0 | 0 | 0 | `Drop_Ammo` avec la locale `index`; la locale `dropped` est deja valide, relire son interaction si necessaire sans elargir le lot. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 166 | 0 | 0 | 0 | 1 | `spawn_temp_t`, puis `sky`, `skyrotate`, `skyaxis` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 80 | 0 | 0 | 0 | 0 | `SP_misc_bigviper`, puis `misc_viper_bomb_touch` / `misc_viper_bomb_prethink` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 34 | 0 | 0 | 0 | 0 | `monster_start`. | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | En cours | 64 | 48 | 0 | 0 | 0 | 0 | `sv_stopspeed`, `sv_friction`, `sv_waterfriction`, `SV_AddRotationalFriction` avec locales `n` et `adjustment`. | Haute |
