...
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 29 | 9 | 0 | 0 | 0 | 0 | Reprendre `ED_CallSpawn`, limite au chemin itemlist/table/warning et au branchement depuis `SpawnEntities`. | Haute |
