...
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 121 | 0 | 0 | 0 | 1 | `door_secret_move4` et `door_secret_move5`, puis leurs doublons matriciels si le lot reste petit. | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 97 | 0 | 0 | 0 | 0 | `Pickup_Ammo` avec les locales `oldcount`, `count` et `weapon` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 163 | 0 | 0 | 0 | 1 | `level_locals_t.current_entity`, `body_que`, `power_cubes` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_misc.c` | [`game_g_misc.c.md`](matrices/game_g_misc.c.md) | [`game_g_misc.c.md`](progress/game_g_misc.c.md) | En cours | 119 | 76 | 0 | 0 | 0 | 0 | `train_use` et `func_train_find`, puis `misc_viper_use` / `SP_misc_viper` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_monster.c` | [`game_g_monster.c.md`](matrices/game_g_monster.c.md) | [`game_g_monster.c.md`](progress/game_g_monster.c.md) | En cours | 45 | 33 | 0 | 0 | 0 | 0 | `monster_death_use`. | Haute |
| `Quake-2-master/game/g_phys.c` | [`game_g_phys.c.md`](matrices/game_g_phys.c.md) | [`game_g_phys.c.md`](progress/game_g_phys.c.md) | En cours | 64 | 39 | 0 | 0 | 0 | 0 | `SV_Physics_Toss`. | Haute |
