...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par famille `m_*` non reservee des consommateurs runtime de `random`/`crandom`; `m_soldier.ts`, `m_tank.ts` et `m_supertank.ts` viennent d'etre migres/verifies, prochain lot recommande autre famille `m_*` ouverte ou `g_utils.ts` quand non reserve. | Haute |
...
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) | [`game_m_actor.h.md`](progress/game_m_actor.h.md) | En cours | 482 | 385 | 0 | 0 | 0 | 0 | `FRAME_bl_swk01` a `FRAME_bl_sws14`. | Haute |
...
| `Quake-2-master/game/m_berserk.h` | [`game_m_berserk.h.md`](matrices/game_m_berserk.h.md) | [`game_m_berserk.h.md`](progress/game_m_berserk.h.md) | En cours | 245 | 110 | 0 | 0 | 0 | 0 | `FRAME_r_att1` a `FRAME_slam23`. | Haute |
...
| `Quake-2-master/game/m_boss2.h` | [`game_m_boss2.h.md`](matrices/game_m_boss2.h.md) | [`game_m_boss2.h.md`](progress/game_m_boss2.h.md) | En cours | 182 | 70 | 0 | 0 | 0 | 0 | `FRAME_attack1` a `FRAME_attack40`. | Haute |
...
| `Quake-2-master/game/m_boss31.c` | [`game_m_boss31.c.md`](matrices/game_m_boss31.c.md) | [`game_m_boss31.c.md`](progress/game_m_boss31.c.md) | En cours | 103 | 66 | 0 | 0 | 0 | 7 | `jorg_frames_start_attack1`, `jorg_move_start_attack1`, `jorg_frames_attack1`, `jorg_move_attack1`, `jorg_frames_end_attack1`, `jorg_move_end_attack1`, puis `jorg_reattack1`/`jorg_attack1` si coherent. | Haute |
| `Quake-2-master/game/m_boss31.h` | [`game_m_boss31.h.md`](matrices/game_m_boss31.h.md) |  | A demarrer | 189 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss32.c` | [`game_m_boss32.c.md`](matrices/game_m_boss32.c.md) | [`game_m_boss32.c.md`](progress/game_m_boss32.c.md) | En cours | 110 | 63 | 0 | 0 | 0 | 8 | `makronBFG`, `makron_frames_attack3`, `makron_move_attack3`, `makron_frames_attack4`, `makron_move_attack4`, `makron_frames_attack5`, `makron_move_attack5`, avec les lignes declaratives associees si coherent. | Haute |
