...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 49 | 0 | 0 | 0 | 64 | `CL_FlyEffect` avec les locaux `n`, `count` et `starttime`; garder `CL_BfgParticles` et le second `BEAMLENGTH` pour une session separee. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par petite famille `m_*` non reservee des consommateurs runtime de `random`/`crandom`; `m_float.ts` vient d'etre migre/verifie, prochain lot recommande `m_flyer.ts` ou autre famille `m_*` non reservee. | Haute |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 17 | 2 | 0 | 0 | 16 | Clarifier les lignes locales restantes `i` et `e` dans la matrice sans traiter les blocages `vectoyaw`/`vectoangles` au-dela du rappel. | Haute |
...
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 42 | 0 | 0 | 0 | 0 | Valider `actorMachineGun` dans un lot separe; garder les sorties muzzleflash/son et le branchement renderer local-gameplay-sync dans le perimetre du lot. | Haute |
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) |  | A demarrer | 482 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 23 | 0 | 0 | 0 | 1 | Valider `berserk_frames_run1` global/table/declarative et `berserk_move_run1`; garder `berserk_run` pour une session separee si le lot devient trop large. | Haute |
| `Quake-2-master/game/m_berserk.h` | [`game_m_berserk.h.md`](matrices/game_m_berserk.h.md) |  | A demarrer | 245 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_boss2.c` | [`game_m_boss2.c.md`](matrices/game_m_boss2.c.md) | [`game_m_boss2.c.md`](progress/game_m_boss2.c.md) | En cours | 78 | 15 | 0 | 0 | 0 | 0 | Valider `boss2_dead` seul, avec bbox finale, `MOVETYPE_TOSS`, `SVF_DEADMONSTER`, `nextthink = 0`, endfunc de `boss2_move_death`, et sortie visible renderer des frames de mort. | Haute |
