...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 37 | 0 | 0 | 0 | 13 | `CL_BlasterParticles`, puis les locaux `d` et `count` si le lot reste coherent. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 271 | 2 | 0 | 0 | 1 | Continuer la migration par famille non reservee des consommateurs runtime de `random`/`crandom` (`g_func.ts` deja migre); reprendre `g_turret.ts`, `g_utils.ts`, `g_weapon.ts` quand ils ne sont plus reserves. | Haute |
...
| `Quake-2-master/game/g_turret.c` | [`game_g_turret.c.md`](matrices/game_g_turret.c.md) | [`game_g_turret.c.md`](progress/game_g_turret.c.md) | En cours | 23 | 10 | 0 | 0 | 0 | 9 | `turret_driver_link` et le local `ent` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 8 | 0 | 0 | 0 | 7 | `vtos`, puis ses locaux `index` et `s` si le lot reste coherent. | Haute |
...
| `Quake-2-master/game/game.h` | [`game_game.h.md`](matrices/game_game.h.md) | [`game_game.h.md`](progress/game_game.h.md) | En cours | 30 | 18 | 0 | 0 | 0 | 0 | `headnode`, puis `svflags`, `solid`, `clipmask` et `owner` si le lot reste coherent. | Haute |
