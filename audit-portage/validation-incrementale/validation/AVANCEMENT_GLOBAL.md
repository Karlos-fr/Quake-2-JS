...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 42 | 0 | 0 | 0 | 37 | `MakeNormalVectors` avec le local `d` si le lot reste coherent; garder `CL_RocketTrail` pour une session separee. | Normale |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 11 | 2 | 0 | 0 | 14 | `G_InitEdict`; `vectoyaw` reste partiel tant que `p_trail.ts` garde son doublon prive; `vectoangles` reste partiel tant que `g_weapon.ts` garde son helper local; clarifier separement la ligne globale `v` pointee vers `g_weapon.ts`. | Haute |
...
| `Quake-2-master/game/game.h` | [`game_game.h.md`](matrices/game_game.h.md) | [`game_game.h.md`](progress/game_game.h.md) | En cours | 30 | 29 | 0 | 0 | 0 | 0 | `GetGameApi` seul. | Haute |
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 22 | 0 | 0 | 0 | 0 | Valider le bloc pain2: `actor_frames_pain2` (lignes global/table/declarative) et `actor_move_pain2`, en gardant `actor_pain` pour un lot separe si le bloc devient trop large. | Haute |
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) |  | A demarrer | 482 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 6 | 0 | 0 | 0 | 0 | `berserk_sight` et `berserk_search` avec leurs emissions sonores et leur branchement via `monsterinfo.sight` / `monsterinfo.search`. | Haute |
