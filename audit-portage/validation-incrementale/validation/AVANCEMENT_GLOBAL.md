...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 31 | 0 | 0 | 0 | 8 | `CL_ParticleEffect` avec le temporaire local `d` si le lot reste coherent. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 260 | 0 | 0 | 0 | 1 | Continuer avec `MOD_TARGET_LASER`, `MOD_TRIGGER_HURT`, `MOD_HIT`, `MOD_TARGET_BLASTER`, `MOD_FRIENDLY_FIRE` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 52 | 0 | 0 | 0 | 4 | `target_earthquake_use`, puis `SP_target_earthquake` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_turret.c` | [`game_g_turret.c.md`](matrices/game_g_turret.c.md) | [`game_g_turret.c.md`](progress/game_g_turret.c.md) | En cours | 23 | 2 | 0 | 0 | 0 | 0 | `turret_blocked` avec le local `attacker`. | Haute |
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) |  | A demarrer | 37 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 12 | 0 | 0 | 0 | 34 | `fire_rocket` et le temporaire local `rocket`. | Haute |
