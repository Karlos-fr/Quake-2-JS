...
| `Quake-2-master/game/g_ai.c` | [`game_g_ai.c.md`](matrices/game_g_ai.c.md) | [`game_g_ai.c.md`](progress/game_g_ai.c.md) | En cours | 48 | 20 | 0 | 0 | 0 | 12 | `ai_run_melee`, `ai_run_missile`, puis `ai_run_slide` avec locale `ofs` | Haute |
...
| `Quake-2-master/game/g_cmds.c` | [`game_g_cmds.c.md`](matrices/game_g_cmds.c.md) | [`game_g_cmds.c.md`](progress/game_g_cmds.c.md) | En cours | 74 | 42 | 0 | 0 | 0 | 0 | `Cmd_WeapNext_f` avec temporaires `it`, `selected_weapon` | Haute |
| `Quake-2-master/game/g_combat.c` | [`game_g_combat.c.md`](matrices/game_g_combat.c.md) | [`game_g_combat.c.md`](progress/game_g_combat.c.md) | En cours | 36 | 22 | 0 | 0 | 0 | 0 | `T_RadiusDamage` avec locales `points`, `ent` | Haute |
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 46 | 0 | 0 | 0 | 0 | `rotating_use` | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 10 | 0 | 0 | 0 | 0 | `Weapon_Grenade` | Haute |
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 31 | 0 | 0 | 0 | 1 | `MELEE_DISTANCE`, `BODY_QUEUE_SIZE` | Haute |
