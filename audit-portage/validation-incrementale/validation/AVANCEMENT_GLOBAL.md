...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 624 | 217 | 0 | 0 | 0 | 1 | Continuer avec `monsterinfo_t.pausetime`, `attack_finished` et `saved_goal` si le lot reste petit. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 19 | 0 | 0 | 0 | 0 | Continuer avec `WriteClient`, puis son temporaire local `field` si le lot reste coherent. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 135 | 23 | 0 | 0 | 0 | 0 | `SP_func_timer`, puis `SP_func_killbox` si le lot reste coherent avec `g_func.ts`; garder `SP_func_clock` pour un lot `g_misc.ts` separe si l'on prefere rester dans le meme fichier cible. | Haute |
| `Quake-2-master/game/g_svcmds.c` | [`game_g_svcmds.c.md`](matrices/game_g_svcmds.c.md) | [`game_g_svcmds.c.md`](progress/game_g_svcmds.c.md) | En cours | 29 | 18 | 0 | 0 | 0 | 0 | `SVCmd_ListIP_f`, puis ses locaux `i` et `b` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 59 | 19 | 0 | 0 | 0 | 0 | `use_target_changelevel` et `SP_target_changelevel` si le lot reste petit. | Haute |
