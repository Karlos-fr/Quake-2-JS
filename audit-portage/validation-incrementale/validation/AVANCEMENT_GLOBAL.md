...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 42 | 1 | 0 | 0 | 38 | Corriger ou justifier le clone prive `MakeNormalVectors` de `packages/client/src/cl_newfx.ts`, puis revalider `MakeNormalVectors`; garder `CL_RocketTrail` pour une session separee. | Normale |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 12 | 2 | 0 | 0 | 14 | `G_Spawn` seul, sans traiter les lignes locales `i`/`e` ni les helpers `vectoyaw`/`vectoangles`; `vectoyaw` reste partiel tant que `p_trail.ts` garde son doublon prive; `vectoangles` reste partiel tant que `g_weapon.ts` garde son helper local; clarifier separement la ligne globale `v` pointee vers `g_weapon.ts`. | Haute |
...
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 26 | 0 | 0 | 0 | 0 | Valider le bloc pain3: `actor_frames_pain3` (lignes global/table/declarative) et `actor_move_pain3`, en gardant `actor_pain` pour un lot separe. | Haute |
| `Quake-2-master/game/m_actor.h` | [`game_m_actor.h.md`](matrices/game_m_actor.h.md) |  | A demarrer | 482 | 0 | 0 | 0 | 0 | 0 |  | Haute |
| `Quake-2-master/game/m_berserk.c` | [`game_m_berserk.c.md`](matrices/game_m_berserk.c.md) | [`game_m_berserk.c.md`](progress/game_m_berserk.c.md) | En cours | 67 | 8 | 0 | 0 | 0 | 0 | `berserk_fidget` seul, avec son emission `sound_idle`, ses branches `AI_STAND_GROUND` / `random()`, et son effet `currentmove = berserk_move_stand_fidget`; garder les tables/frames/moves pour une session separee si le lot devient trop large. | Haute |
