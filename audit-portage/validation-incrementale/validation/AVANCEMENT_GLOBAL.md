...
| `Quake-2-master/game/g_ai.c` | [`game_g_ai.c.md`](matrices/game_g_ai.c.md) | [`game_g_ai.c.md`](progress/game_g_ai.c.md) | En cours | 48 | 10 | 0 | 0 | 0 | 3 | `range` et locale `len`, ou `visible` avec locale `trace` | Haute |
...
| `Quake-2-master/game/g_cmds.c` | [`game_g_cmds.c.md`](matrices/game_g_cmds.c.md) | [`game_g_cmds.c.md`](progress/game_g_cmds.c.md) | En cours | 74 | 22 | 0 | 0 | 0 | 0 | `Cmd_Notarget_f` et temporaires `msg` | Haute |
| `Quake-2-master/game/g_combat.c` | [`game_g_combat.c.md`](matrices/game_g_combat.c.md) | [`game_g_combat.c.md`](progress/game_g_combat.c.md) | En cours | 36 | 5 | 0 | 0 | 0 | 0 | `CheckArmor` et variables locales associees | Haute |
| `Quake-2-master/game/g_func.c` | [`game_g_func.c.md`](matrices/game_g_func.c.md) | [`game_g_func.c.md`](progress/game_g_func.c.md) | En cours | 150 | 19 | 0 | 0 | 0 | 0 | `AccelerationDistance`, `plat_CalcAcceleratedMove`, `plat_Accelerate` | Haute |
| `Quake-2-master/game/g_items.c` | [`game_g_items.c.md`](matrices/game_g_items.c.md) | [`game_g_items.c.md`](progress/game_g_items.c.md) | En cours | 109 | 3 | 0 | 0 | 0 | 0 | `Weapon_Blaster` | Haute |
