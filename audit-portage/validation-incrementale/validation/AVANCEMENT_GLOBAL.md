...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 623 | 367 | 0 | 0 | 0 | 119 | Traiter `gclient_s`, puis son debut `ps`, `ping`, `old_pmove`, `showscores`, `showinventory`, `showhelp`, `showhelpicon`, `ammo_index`, `buttons`, `oldbuttons`, `latched_buttons` si le lot reste coherent. | Haute |
...
| `Quake-2-master/game/m_medic.c` | [`game_m_medic.c.md`](matrices/game_m_medic.c.md) | [`game_m_medic.c.md`](progress/game_m_medic.c.md) | En cours | 83 | 53 | 0 | 0 | 0 | 8 | Continuer avec `medic_frames_attackHyperBlaster`, `medic_move_attackHyperBlaster`, `medic_continue`, puis `medic_frames_attackBlaster`/`medic_move_attackBlaster` si le lot reste coherent. | Haute |
...
| `Quake-2-master/game/m_mutant.c` | [`game_m_mutant.c.md`](matrices/game_m_mutant.c.md) | [`game_m_mutant.c.md`](progress/game_m_mutant.c.md) | En cours | 92 | 57 | 0 | 0 | 0 | 4 | Continuer avec le bloc pain: `mutant_frames_pain1`, `mutant_move_pain1`, `mutant_frames_pain2`, `mutant_move_pain2`, `mutant_frames_pain3`, `mutant_move_pain3`, `mutant_pain`, puis la variable locale `r`. | Haute |
