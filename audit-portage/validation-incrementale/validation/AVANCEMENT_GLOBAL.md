...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 33 | 0 | 0 | 0 | 10 | `CL_ParticleEffect3` avec son temporaire local `d`. | Normale |
...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 267 | 0 | 0 | 0 | 1 | `FOFS`, puis `STOFS`/`LLOFS`/`CLOFS` si coherent. | Haute |
...
| `Quake-2-master/game/g_turret.c` | [`game_g_turret.c.md`](matrices/game_g_turret.c.md) | [`game_g_turret.c.md`](progress/game_g_turret.c.md) | En cours | 23 | 4 | 0 | 0 | 0 | 3 | `turret_breach_think` avec le premier petit sous-lot de locaux `ent`, `angle`, `target_z`, `diff`. | Haute |
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 2 | 0 | 0 | 0 | 1 | `findradius`, puis local C `j` si le lot reste petit. | Haute |
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 14 | 0 | 0 | 0 | 41 | Confirmer le deuxieme `ignore` de la matrice, puis `bfg_explode` et ses locaux. | Haute |
| `Quake-2-master/game/game.h` | [`game_game.h.md`](matrices/game_game.h.md) | [`game_game.h.md`](progress/game_game.h.md) | En cours | 29 | 5 | 0 | 0 | 0 | 0 | `link_s`, puis `MAX_ENT_CLUSTERS` si le lot reste petit. | Haute |
