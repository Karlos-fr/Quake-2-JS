...
| `Quake-2-master/client/cl_fx.c` | [`client_cl_fx.c.md`](matrices/client_cl_fx.c.md) | [`client_cl_fx.c.md`](progress/client_cl_fx.c.md) | En cours | 145 | 41 | 0 | 0 | 0 | 30 | `CL_DiminishingTrail`, puis les locaux `move`, `vec`, `len`, `j`, `dec`, `orgscale` et `velscale` si le lot reste coherent. | Normale |
...
| `Quake-2-master/game/g_utils.c` | [`game_g_utils.c.md`](matrices/game_g_utils.c.md) | [`game_g_utils.c.md`](progress/game_g_utils.c.md) | En cours | 37 | 10 | 2 | 0 | 0 | 13 | `G_CopyString` avec son local `out` si le lot reste petit; `vectoyaw` reste partiel tant que `p_trail.ts` garde son doublon prive; `vectoangles` reste partiel tant que `g_weapon.ts` garde son helper local; clarifier separement la ligne globale `v` pointee vers `g_weapon.ts`. | Haute |
...
| `Quake-2-master/game/game.h` | [`game_game.h.md`](matrices/game_game.h.md) | [`game_game.h.md`](progress/game_game.h.md) | En cours | 30 | 26 | 0 | 0 | 0 | 0 | `edict_size`, `num_edicts` et `max_edicts` dans un lot separe si coherent. | Haute |
| `Quake-2-master/game/m_actor.c` | [`game_m_actor.c.md`](matrices/game_m_actor.c.md) | [`game_m_actor.c.md`](progress/game_m_actor.c.md) | En cours | 69 | 18 | 0 | 0 | 0 | 0 | Valider le bloc pain1: `actor_frames_pain1` (lignes global/table/declarative) et `actor_move_pain1`, en gardant `actor_pain` pour un lot separe si le bloc devient trop large. | Haute |
