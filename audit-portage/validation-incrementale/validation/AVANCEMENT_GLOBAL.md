...
| `Quake-2-master/game/g_local.h` | [`game_g_local.h.md`](matrices/game_g_local.h.md) | [`game_g_local.h.md`](progress/game_g_local.h.md) | En cours | 620 | 247 | 0 | 0 | 0 | 1 | Continuer avec les macros environnement/monde `MOD_WATER` a `MOD_HELD_GRENADE` si le lot reste petit, avec preuves combat/death messages et sorties visibles associees. | Haute |
...
| `Quake-2-master/game/g_save.c` | [`game_g_save.c.md`](matrices/game_g_save.c.md) | [`game_g_save.c.md`](progress/game_g_save.c.md) | En cours | 52 | 46 | 0 | 0 | 0 | 0 | Continuer avec les lignes auto-detectees restantes autour des temporaires `index` de `WriteField1`/`ReadField`, en les regroupant par fonction d'origine. | Haute |
| `Quake-2-master/game/g_spawn.c` | [`game_g_spawn.c.md`](matrices/game_g_spawn.c.md) | [`game_g_spawn.c.md`](progress/game_g_spawn.c.md) | En cours | 29 | 14 | 0 | 0 | 0 | 14 | Examiner la ligne `strncpy` de la matrice: appel libc externe de `SP_worldspawn`/`SpawnEntities`, probablement a retirer ou marquer non applicable avec justification. | Haute |
...
| `Quake-2-master/game/g_target.c` | [`game_g_target.c.md`](matrices/game_g_target.c.md) | [`game_g_target.c.md`](progress/game_g_target.c.md) | En cours | 58 | 47 | 0 | 0 | 0 | 3 | `target_lightramp_use` avec le local `e`, puis `SP_target_lightramp` si le lot reste raisonnable. | Haute |
...
| `Quake-2-master/game/g_weapon.c` | [`game_g_weapon.c.md`](matrices/game_g_weapon.c.md) | [`game_g_weapon.c.md`](progress/game_g_weapon.c.md) | En cours | 69 | 10 | 0 | 0 | 0 | 31 | `fire_grenade2` et son temporaire local `grenade` si le lot reste petit. | Haute |
