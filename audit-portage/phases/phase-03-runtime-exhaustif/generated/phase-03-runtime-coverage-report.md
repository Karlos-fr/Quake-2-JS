...
- Fichiers TS runtime indexes : 147
- Symboles source indexes : 14150
- Symboles TS indexes : 16275
...
- Verdicts fichier : Partiel=3, A redecouper=124
...
- Lignes avec symbole TS : 11415
- Lignes sans symbole TS : 2735
- Lignes avec tests lies : 14069
...
| Racine | Statut | C | TS |
| --- | --- | --- | --- |
| Qcommon_Frame | found-in-c-and-ts | Quake-2-master/qcommon/common.c:1491<br>Quake-2-master/qcommon/qcommon.h:772 | packages/qcommon/src/qcommon.ts:1316 |
| SV_Frame | found-in-c-and-ts | Quake-2-master/qcommon/qcommon.h:823<br>Quake-2-master/server/sv_main.c:760<br>Quake-2-master/server/sv_null.c:12 | packages/server/src/host.ts:112<br>packages/server/src/sv_main.ts:932<br>packages/server/src/sv_null.ts:62<br>packages/qcommon/src/qcommon.ts:1583 |
| SV_RunGameFrame | found-in-c-and-ts | Quake-2-master/server/sv_main.c:723 | packages/server/src/sv_main.ts:899 |
| G_RunFrame | found-in-c-and-ts | Quake-2-master/game/g_main.c:87<br>Quake-2-master/game/g_main.c:353 | packages/game/src/g_main.ts:320<br>packages/game/src/g_phys.ts:828 |
| ClientThink | found-in-c-and-ts | Quake-2-master/game/g_main.c:75<br>Quake-2-master/game/p_client.c:1570 | packages/game/src/p_client.ts:1657 |
| ClientBeginServerFrame | found-in-c-and-ts | Quake-2-master/game/g_local.h:756<br>Quake-2-master/game/p_client.c:1755 | packages/game/src/p_client.ts:1791 |
| CL_Frame | found-in-c-and-ts | Quake-2-master/client/cl_main.c:1677<br>Quake-2-master/qcommon/qcommon.h:817 | packages/client/src/cl_main.ts:962<br>packages/qcommon/src/qcommon.ts:1518 |
| CL_SendCommand | found-in-c-and-ts | Quake-2-master/client/cl_main.c:1649 | packages/client/src/cl_main.ts:941 |
| CL_SendCmd | found-in-c-and-ts | Quake-2-master/client/cl_input.c:453<br>Quake-2-master/client/client.h:481 | packages/client/src/cl_input.ts:544 |
| CL_ReadPackets | found-in-c-and-ts | Quake-2-master/client/cl_main.c:987<br>Quake-2-master/client/client.h:486 | packages/client/src/cl_main.ts:1323 |
| CL_ParseServerMessage | found-in-c-and-ts | Quake-2-master/client/cl_parse.c:652<br>Quake-2-master/client/client.h:509 | packages/client/src/cl_parse.ts:1404 |
| PMove | found-in-c-and-ts | Quake-2-master/qcommon/pmove.c:1240<br>Quake-2-master/qcommon/qcommon.h:685 | packages/client/src/local-gameplay-sync.ts:703<br>packages/qcommon/src/pmove.ts:1289 |
...
| Quake-2-master/client/cl_pred.c | packages/client/src/view.ts | declared-target-not-strict-basename<br>phase02-structural-status:wrong-name<br>strict-basename-target-missing |
...
| Quake-2-master/client/cl_view.c | packages/client/src/view.ts | declared-target-not-strict-basename<br>multiple-declared-ts-targets<br>phase02-structural-status:split-undocumented<br>strict-basename-target-missing |
...
| Quake-2-master/client/sound.h | packages/client/src/sound-public.ts | declared-target-not-strict-basename<br>multiple-declared-ts-targets<br>phase02-structural-status:split-undocumented |
...
| ... | ... | 44 fichiers supplementaires dans phase-03-runtime-file-audits.json |

## Restes Runtime

- Fichiers Partiel : 3
- Fichiers avec symboles TS manquants : 82
- Fichiers sans test lie : 2
...
| Quake-2-master/qcommon/cvar.c | Partiel | 26 | missing-ts-symbols:26<br>unreachable-functions:5 |
| Quake-2-master/qcommon/pmove.c | Partiel | 25 | header:stub marker detected<br>header:temporary marker detected<br>missing-ts-symbols:25 |
...
| Quake-2-master/client/cl_ents.c | packages/renderer-three/src/refresh-entity-sync.ts<br>packages/renderer-three/src/md2-mesh-builder.ts | multiple-declared-ts-targets |
...
| Quake-2-master/client/cl_view.c | apps/web/src/local-client-controller.ts<br>packages/renderer-three/src/refresh-entity-sync.ts | adapter-target-declared<br>declared-target-not-strict-basename<br>multiple-declared-ts-targets<br>strict-basename-target-missing |
