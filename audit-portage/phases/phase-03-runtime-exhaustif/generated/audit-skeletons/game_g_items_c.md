...
- Cibles TS declarees : packages/game/src/g_items.ts, packages/game/src/p_weapon.ts, packages/game/src/local-game-bootstrap.ts, packages/game/src/g_spawn.ts, packages/game/src/g_combat.ts, packages/game/src/index.ts
